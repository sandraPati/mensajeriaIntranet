...
@Controller
@RequestMapping("/emp/*")
public class EmpControllerPropuestaPasoPresupuesto {
    @Autowired
    ...
    @RequestMapping(value = "ENuevaPropuestaPresupuesto.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPresupuesto_get(ModelMap map,@RequestParam(value = "idP") int idP,@RequestParam(value = "msg", required = false) String msg) {        
        ...
        return "ENuevaPropuestaPresupuesto";
    }
    
    @RequestMapping(value = "ENuevaPropuestaPresupuesto2.htm",method=RequestMethod.GET)
    public String addPresupuesto2_get(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idC")int idC) {
       ...
       // map.addAttribute("ltaCapitulos",ltaCapitulos);
        ...
        return "ENuevaPropuestaPresupuesto2";
    }
   
    @RequestMapping("/ENuevaPropuestajsonguardarPanosSelecAddPresup.htm")
    public @ResponseBody String jsonguardarPanosSelecAddPresup(@RequestBody presupuesto pre ){
        ...
        return "/Intranet/emp/ENuevaPropuestaPresupuesto2.htm?idP="+pp.getPropuesta_id()+"&idC="+pp.getCapitulo_id(); 
    }
    
    @RequestMapping(value = "ENuevaPropuestaPresupuesto3.htm",method=RequestMethod.GET)
    public String addPresupuesto3_get(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC) {
        ...
        try{
            ...
            if(presup.getTipoCantidad().equals("und.")){
                ruta="ENuevaPropuestaPresupuesto3";            
                String r=validaInterfacesRoles.valida();
                map.addAttribute("menu",r);
                map.addAttribute("p",p);
                map.addAttribute("presup",presup);
            }else  ruta="redirect:ENuevaPropuestaPresupuesto4.htm?idP="+idP+"&idPre="+idPre+"&idSC="+idSC; 
    ...
    @RequestMapping(value = "ENuevaPropuestaPresupuesto3.htm",method=RequestMethod.POST)
    public String addPresupuesto3_post(ModelMap map,@ModelAttribute("presup")presupuesto presup2,BindingResult result) {
      // String ruta="redirect:Presupuesto.htm?idP="+presup2.getPropuesta_id();
        String ruta="redirect:ENuevaPropuestaPresupuesto2.htm?idP="+presup2.getProp()+"&idC="+presup2.getCapitulo().getId();
        try{
    ...
    @RequestMapping("ENuevaPropuestaPresupuesto4.htm")
    public String addPresupuesto4(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC) {
        ...
        return("ENuevaPropuestaPresupuesto4");
        
    }
    
    @RequestMapping(value = "ENuevaPropuestaPresupuesto5.htm",method=RequestMethod.GET)
    public String addPresupuesto5_get(ModelMap map,@RequestParam(value = "idE") int idE,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC,@RequestParam(value = "idPresup") int idPresup) {
        ...
        return("ENuevaPropuestaPresupuesto5");
    }
    
    @RequestMapping(value = "ENuevaPropuestaPresupuesto6.htm",method=RequestMethod.GET)
    public String addPresupuesto6_get(ModelMap map,@RequestParam(value = "idE") int idE,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC,@RequestParam(value = "idPresup") int idPresup,@RequestParam(value = "idPsp") int idPsp,@RequestParam(value = "idPano") int idPano) {
     ...
     try{
        ...
        return("ENuevaPropuestaPresupuesto6");
    }
    
    @RequestMapping(value = "ENuevaPropuestaPresupuestoG.htm",method=RequestMethod.GET)
    public String addPresupuestoG_get(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC,@RequestParam(value="idPresup")int idPresup) {
        String ruta="ENuevaPropuestaPresupuestoG";
        propuesta p=new propuesta();
        //List<capitulos> ltaCapitulos=null;
       // List<subcapitulos> ltaSubCapitulos=null;
        try{
            ...
            if(s==0){
                ruta="redirect:ENuevaPropuestaPresupuesto4.htm?idP="+idP+"&idPre="+idPre+"&idSC="+idSC;
           }else{
    ...
    @RequestMapping(value = "ENuevaPropuestaPresupuestoG.htm",method=RequestMethod.POST)
    public String addPresupuestoG_post(ModelMap map,@ModelAttribute("presup")presupuesto presup2,BindingResult result) {
        ...
        return "redirect:ENuevaPropuestaPresupuesto2.htm?idP="+presup2.getProp()+"&idC="+presup2.getCapitulo().getId(); 
    }
    
    @RequestMapping(value = "ENuevaPropuestaPresupuestoasignarLtaGuardada.htm",method=RequestMethod.GET)
    public String asignarLtaGuardada(@RequestParam(value = "idP") int idP,@RequestParam(value = "idPre") int idPre,@RequestParam(value = "idSC") int idSC,ModelMap map) {
        ...
        return "redirect:ENuevaPropuestaPresupuesto2.htm?idP="+idP+"&idC="+pres.getCapitulo().getId();  
    }
    
    @RequestMapping(value = "ENuevaPropuestaVerPresupuestoPdf.htm",method=RequestMethod.GET)
            ...
            if(res==true){
                ...
                prop=propuestasService.porId(idPr);
                   ...
                   String r=validaInterfacesRoles.valida();
                    ...
                    ruta="ENuevaPropuestaVerPresupuestoPdf";
            }else{
                prop=propuestasService.porId(idPr);
                map.addAttribute("msg","error");
                ruta="redirect:ENuevaPropuestaPresupuesto.htm?idP="+idPr;
            }        
    ...
    @RequestMapping(value = "ENuevaPropuestaenviarPresupuesto.htm",method=RequestMethod.GET)
    public String enviarPresupuesto(@RequestParam(value = "idP") int idPr,ModelMap map) {
        ...
        return "redirect:ENuevaPropuestaPresupuesto.htm?idP="+idPr;
    }
}
