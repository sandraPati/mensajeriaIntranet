...
@Controller
@RequestMapping("/sup/*")
public class SupControllerPresupuestoExpres {
     @Autowired
    ...
    @RequestMapping("PresupuestoExpres.htm")
    public String PresupuestoExpress(ModelMap map,@RequestParam("idP")int idP){
       ...
       List<estancias> ltaEstancias=null;
        ...
        return "PresupuestoExpres";
    }
    @RequestMapping(value = "PExpres.htm",method=RequestMethod.GET)
...
@RequestMapping(value = "NuevaPropuestaPExpres.htm",method=RequestMethod.GET)
...
private void presupuesto1m2suelo(presupuesto_expres pex,int cap,int subcap,int idsuelo) {
    ...
    private void presupuesto1und(presupuesto_expres pex,int cap,int subcap,int und) {
     ...
     @RequestMapping("/jsonPresupuestoExpres.htm")
    ...
    @RequestMapping("/jsonPresupuestoExpresDelete.htm")
    ...
    @RequestMapping("/jsonPresupuestoExpressMedida.htm")
    ...
    private void presupuesto1m2pano(presupuesto_expres pex, int c, int scap, int r) {
     ...
     @RequestMapping(value = "NuevaPropuestaExpres.htm",method=RequestMethod.GET)
    public String NuevaPropuestaExpres_get(ModelMap map) {        
        ...
        return "NuevaPropuestaExpres";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresAdd.htm",method=RequestMethod.GET)
    public String NuevaPropuestaExpresAdd_get(ModelMap map,@RequestParam(value="cli")String nif) {        
        ...
        map.addAttribute("prop",prop);
        return "NuevaPropuestaExpresAdd";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresAdd.htm",method=RequestMethod.POST)
    public String NuevaPropuestaExpresAdd_post(@ModelAttribute("prop")propuesta prop,BindingResult result,Principal principal) {
        ...
        try{
         ...
         return "redirect:NuevaPropuestaExpresEstancias.htm?idP="+id;
        
        
        
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresEstancias.htm",method=RequestMethod.GET)
    public String NuevaPropuestaExpresEstancias_get(ModelMap map,@RequestParam(value="idP")int id) {        
        ...
        return "NuevaPropuestaExpresEstancias";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresEstancias.htm",method=RequestMethod.POST)
    public String NuevaPropuestaExpresEstancias_post(@ModelAttribute("estancia")estancias estan,BindingResult result) {
        ...
        try{
         ...
         return "redirect:NuevaPropuestaExpresPanos.htm?idE="+idE;
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresPanos.htm",method=RequestMethod.GET)
    public String NuevaPropuestaExpresPanos_get(ModelMap map,@RequestParam(value="idE")int idE) {        
        ...
        return "NuevaPropuestaExpresPanos";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresPanos.htm",method=RequestMethod.POST)
    public String NuevaPropuestaExpresPanos_post(@ModelAttribute("pa")panos pan,BindingResult result) {
        ...
        try{
            ...
            //e.setId(idE);
                    ...
                    if(pan.getTipo_pano_id().getId()!=1)ruta="redirect:NuevaPropuestaExpresFinEstancia.htm?idE="+pan.getEstancia_id().getId();
                    else{
                        int idPan=panosService.idultimo(pan.getEstancia_id().getId());
                        ruta="redirect:NuevaPropuestaExpresVentanas.htm?idP="+idPan;
                    }
    ...
    @RequestMapping(value = "NuevaPropuestaExpresVentanas.htm",method=RequestMethod.GET)
    public String NuevaPropuestaExpresVentanas_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        map.addAttribute("menu",r);
        map.addAttribute("pa",pano);
        return "NuevaPropuestaVentanas";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresVentanas.htm",method=RequestMethod.POST)
    public String NuevaPropuestaExpresVentanas_post(@ModelAttribute("pa")panos p,BindingResult result) {
        ...
        try{
            ...
            if(p.getVentana().equals("SI")){
                ruta="redirect:NuevaPropuestaExpresVentanasF.htm?idP="+p.getId();
            }else ruta="redirect:NuevaPropuestaExpresPuertas.htm?idP="+p.getId();
        }catch(Exception ex){}  
         return ruta;
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresVentanasF.htm",method=RequestMethod.GET)
    public String NuevaPropuestaVentanasF_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        return "NuevaPropuestaExpresVentanasF";
    }
    @RequestMapping(value = "NuevaPropuestaExpresVentanasF.htm",method=RequestMethod.POST)
    public String addVentanasF_post(@ModelAttribute("vent")ventanas v,BindingResult result) {
        String ruta="redirect:NuevaPropuestaExpresVentanasF.htm?idP="+v.getIdpano().getId();
        List<ventanas> ltaventana=null;
        try{
            //vent=v;
            ...
            if(pano.getNumventanas()==ltaventana.size()){
                ruta="redirect:NuevaPropuestaExpresPuertas.htm?idP="+pano.getId();
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "NuevaPropuestaExpresPuertas.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPuertas_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        map.addAttribute("menu",r);
        map.addAttribute("pa",pano);
        return "NuevaPropuestaExpresPuertas";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresPuertas.htm",method=RequestMethod.POST)
    public String NuevaPropuestaPuertas_post(@ModelAttribute("pa")panos p,BindingResult result) {
        ...
        try{
            ...
            if(p.getPuertas().equals("SI")){
                ruta="redirect:NuevaPropuestaExpresPuertasF.htm?idP="+p.getId();
            }else ruta="redirect:NuevaPropuestaExpresArmarios.htm?idP="+p.getId();
        }catch(Exception ex){}  
         return ruta;
    }
    @RequestMapping(value = "NuevaPropuestaExpresPuertasF.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPuertasF_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        return "NuevaPropuestaExpresPuertasF";
    }
    @RequestMapping("/ExpresjsonNuevaPropuestaEjaddPuertasF.htm")
    public @ResponseBody String ExpresjsonNuevaPropuestaEjaddPuertasF(@RequestBody puertas p ){
        ...
        String ruta="/Intranet/sup/NuevaPropuestaExpresPuertasF.htm?idP="+p.getId_pano();
        try{
            ...
            if(pano.getNumpuertas()==ltapuerta.size()){
                ruta="/Intranet/sup/NuevaPropuestaExpresArmarios.htm?idP="+p.getId_pano();
            }
        }catch(Exception ex){}
        return ruta; 
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresArmarios.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPuertasExpresArmarios_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        map.addAttribute("menu",r);
        map.addAttribute("pa",pano);
        return "NuevaPropuestaExpresArmarios";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresArmarios.htm",method=RequestMethod.POST)
    public String NuevaPropuestaPuertasExpresArmarios_post(@ModelAttribute("pa")panos p,BindingResult result) {
        ...
        try{
            ...
            if(p.getArmario().equals("SI")){
                ruta="redirect:NuevaPropuestaExpresArmariosF.htm?idP="+p.getId();
            }else ruta="redirect:NuevaPropuestaExpresFinEstancia.htm?idE="+pa.getEstancia_id().getId();
        }catch(Exception ex){}  
         return ruta;
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresArmariosF.htm",method=RequestMethod.GET)
    public String NuevaPropuestaArmariosF_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        return "NuevaPropuestaExpresArmariosF";
    }
    @RequestMapping(value = "NuevaPropuestaExpresArmariosF.htm",method=RequestMethod.POST)
    public String NuevaPropuestaArmariosF_post(@ModelAttribute("arm")armarios v,BindingResult result) {
        String ruta="redirect:NuevaPropuestaExpresArmariosF.htm?idP="+v.getIdpano().getId();
        List<armarios> ltaarmario=null;
        try{
            //vent=v;
            panos pano=panosService.porID(v.getIdpano().getId());
            ...
            if(pano.getNumarmarios()==ltaarmario.size()){
                ruta="redirect:NuevaPropuestaExpresFinEstancia.htm?idE="+pano.getEstancia_id().getId();
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "NuevaPropuestaExpresFinEstancia.htm",method=RequestMethod.GET)
    public String NuevaPropuestaFinEstancia_get(ModelMap map,@RequestParam(value="idE")int idE) {
        ...
        map.addAttribute("idP",est.getPropuesta_id().getId());
        return "NuevaPropuestaExpresFinEstancia";
    }
    
    
    @RequestMapping(value = "NuevaPropuestaExpresFinPropuesta2.htm",method=RequestMethod.GET)
    public String NuevaPropuestaFinPropuesta2(ModelMap map,@RequestParam(value="idE")int idE) {
        ...
        return "redirect:NuevaPropuestaExpresVerPanos.htm?idE="+idE;
    }
    
    
    
     @RequestMapping("NuevaPropuestaExpresVerPanos.htm")
    public String NuevaPropuestaVerPanos(@RequestParam(value = "idE") int idE,ModelMap map) {
        ...
        map.addAttribute("ltaPanos",ltaPanos);
        return("NuevaPropuestaExpresVerPanos");
        
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresDeleteEstancia.htm",method=RequestMethod.GET)
    public String NuevaPropuestaDeleteEstancia(@RequestParam(value = "idE") int idE,@RequestParam(value = "idP") int idP,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaExpresVerEstancia.htm?idP="+idP;
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresDeletePano.htm",method=RequestMethod.GET)
    ...
    @RequestMapping("NuevaPropuestaExpresVerP.htm")
    public String verPanos(@RequestParam(value = "idPano") int idPano,ModelMap map) {
        ...
        return("NuevaPropuestaExpresVerP");
        
    }
    
    
    @RequestMapping(value = "NuevaPropuestaExpresvolcarPano.htm",method=RequestMethod.GET)
    public String NuevaPropuestavolcarPano(@RequestParam(value = "idPano") int idPano,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaExpresVerPanos.htm?idE="+pano2.getEstancia_id().getId();
    }
 
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdatePano.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdatePano_get(ModelMap map,@RequestParam(value = "idP") int idPano) {
        ...
        return "NuevaPropuestaExpresUpdatePano";
    }
    
     @RequestMapping(value = "NuevaPropuestaExpresUpdatePano.htm",method=RequestMethod.POST)
    public String updatePano_post(@ModelAttribute("pa")panos pan,BindingResult result) {
        String ruta="redirect:NuevaPropuestaExpresUpdateVentanas.htm?idP="+pan.getId();
        List<panos> ltapanos=null;
                    ...
                    if(pan.getTipo_pano_id().getId()!=1){
                        ...
                        ruta="redirect:NuevaPropuestaExpresVerPanos.htm?idE="+pan.getEstancia_id().getId();
                    }else{ 
                        pan.setTotal(pan.getSuperficie());
                        panosService.Update(pan);
                    }
    ...
    @RequestMapping(value = "NuevaPropuestaExpresUpdateVentanas.htm",method=RequestMethod.GET)
    public String EjupdateVentanas_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        map.addAttribute("ltaventana",ltaventana);
        return "NuevaPropuestaExpresUpdateVentanas";
    }
    
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdateVentanasF.htm",method=RequestMethod.GET)
    public String EjupdateVentanasF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "NuevaPropuestaExpresUpdateVentanasF";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdateVentanasF.htm",method=RequestMethod.POST)
    public String EjupdateVentanasF_post(@ModelAttribute("vent")ventanas v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:NuevaPropuestaExpresUpdateVentanas.htm?idP="+v.getIdpano().getId()+"";
    }
     @RequestMapping(value = "NuevaPropuestaExpresUpdateVentanasFadd.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdateVentanasFadd_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "NuevaPropuestaExpresUpdateVentanasFadd";
    }
    @RequestMapping(value = "NuevaPropuestaExpresUpdateVentanasFadd.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "NuevaPropuestaExpresDeleteVentanas.htm",method=RequestMethod.GET)
    public String EjdeleteVentanas(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaExpresUpdateVentanas.htm?idP="+ventana.getIdpano().getId()+"";
    }
    //puertas
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdatePuertas.htm",method=RequestMethod.GET)
    public String EjupdatePuertas_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        map.addAttribute("idPano",id);
        map.addAttribute("ltapuerta",ltapuerta);
        return "NuevaPropuestaExpresUpdatePuertas";
    }
    
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdatePuertasF.htm",method=RequestMethod.GET)
    public String EjupdatePuertasF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "NuevaPropuestaExpresUpdatePuertasF";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdatePuertasF.htm",method=RequestMethod.POST)
    public String EjupdatePuertasF_post(@ModelAttribute("pu")puertas v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:NuevaPropuestaExpresUpdatePuertas.htm?idP="+v.getIdpano().getId()+"";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdatePuertasFadd.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdatePuertasFadd_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "NuevaPropuestaExpresUpdatePuertasFadd";
    }
    @RequestMapping(value = "NuevaPropuestaExpresUpdatePuertasFadd.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "NuevaPropuestaExpresDeletePuertas.htm",method=RequestMethod.GET)
    public String EjdeletePuertas(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaExpresUpdatePuertas.htm?idP="+p.getIdpano().getId()+"";
    }
    
    //armarios
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdateArmario.htm",method=RequestMethod.GET)
    public String EjupdateArmario_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        map.addAttribute("idPano",id);
        map.addAttribute("ltaarmario",ltaarmario);
        return "NuevaPropuestaExpresUpdateArmario";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdateArmarioF.htm",method=RequestMethod.GET)
    public String EjupdateArmarioF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "NuevaPropuestaExpresUpdateArmarioF";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdateArmarioF.htm",method=RequestMethod.POST)
    public String EjupdateArmarioF_post(@ModelAttribute("arm")armarios v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:NuevaPropuestaExpresUpdateArmario.htm?idP="+v.getIdpano().getId()+"";
    }
    
    @RequestMapping(value = "NuevaPropuestaExpresUpdateArmarioFadd.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdateArmarioFadd_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "NuevaPropuestaExpresUpdateArmarioFadd";
    }
    @RequestMapping(value = "NuevaPropuestaExpresUpdateArmarioFadd.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "NuevaPropuestaExpresDeleteArmario.htm",method=RequestMethod.GET)
    public String EjdeleteArmario(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaExpresUpdateArmario.htm?idP="+p.getIdpano().getId()+"";
    }
    @RequestMapping(value = "NuevaPropuestaExpresUpdateFinish.htm",method=RequestMethod.GET)
    public String EjupdateFinish(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "redirect:NuevaPropuestaExpresVerPanos.htm?idE="+est.getId();
    }
