...
@Controller
@RequestMapping("/sup/*")
public class SupControllerPropuesta {
    @Autowired
    ...
    //private static  propuesta prop=new propuesta();
    ...
    @RequestMapping("SLtaClientesPropuesta.htm")
    public ModelAndView DocumentosContratosList(ModelAndView mav){
        ...
        mav.setViewName("SLtaClientesPropuesta");        
        return mav;
    }
    
    
    @RequestMapping(value = "addCliente.htm",method=RequestMethod.GET)
    ...
    public String addCliente_post(@ModelAttribute("cliente")clientes cliente,BindingResult result) {
        ...
        try{
         ...
         return "redirect:SLtaClientesPropuesta.htm";
        
    }
    @RequestMapping("verPropuestas.htm")
    public String verPropuestas(@RequestParam(value = "nifC") String nif,@RequestParam(value = "msg", required = false) String msg,ModelMap map) {
        ...
        return("verPropuestas");
        
    }
    
   /* @RequestMapping(value = "CrearPlantilla.htm",method=RequestMethod.GET)
    public String CrearPlantilla(@RequestParam(value = "nifC") String nifC,@RequestParam(value = "idP") int idP,ModelMap map) {
        String rpta="";
        try{
            plantillaPresupuesto pp=new plantillaPresupuesto();
            pp.setPropuesta_id(idP);
            pp.setDescripcion("Baño"+idP);
        ...
        return "redirect:verPropuestas.htm?nifC="+nifC;
    }*/
   
    @RequestMapping("/CrearPlantilla.htm")
    public @ResponseBody String CrearPlantilla(@RequestBody plantillaPresupuesto pre ){
        ...
        return "/Intranet/sup/verPropuestas.htm?nifC="+prop.getCliente_nif().getNif(); 
    }
    @RequestMapping("/DeletePlantilla.htm")
    ...
    @RequestMapping(value = "AsignarPlantilla.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "addPropuesta.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "addPropuesta.htm",method=RequestMethod.POST)
    public String addPropuesta_post(@ModelAttribute("prop")propuesta prop,BindingResult result,Principal principal) {
        ...
        try{
         ...
         return "redirect:verPropuestas.htm?nifC="+prop.getCliente_nif().getNif();
        
        
        
    }
    
    @RequestMapping(value = "updatePropuesta.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "updatePropuesta.htm",method=RequestMethod.POST)
   ...
   @RequestMapping("consultarPropuesta.htm")
    ...
    @RequestMapping(value = "deleteEstancia.htm",method=RequestMethod.GET)
    public String deleteEstancia(@RequestParam(value = "idE") int idE,@RequestParam(value = "idP") int idP,ModelMap map) {
        ...
        return "redirect:consultarPropuesta.htm?idP="+idP;
    }
    
    @RequestMapping(value = "addEstancia.htm",method=RequestMethod.GET)
    public String addEstancia_get(ModelMap map,@RequestParam(value = "idP") int idP) {
        ...
        return "EjaddEstancia.htm?idP="+idP;
    }
    
    @RequestMapping(value = "addEstancia.htm",method=RequestMethod.POST)
    public String addEstancia_post(@ModelAttribute("estancia")estancias est,BindingResult result,Principal principal) {
        ...
        try{
         ...
         return "redirect:consultarPropuesta.htm?idP="+prop.getId();
    }
    
    @RequestMapping("verEstancias.htm")
    ...
    @RequestMapping(value = "volcarPano.htm",method=RequestMethod.GET)
    public String volcarPano(@RequestParam(value = "idPano") int idPano,ModelMap map) {
        ...
        return "redirect:verEstancias.htm?idE="+pano2.getEstancia_id().getId();
    }
    
    @RequestMapping(value = "addPano.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "addPano.htm",method=RequestMethod.POST)
    public String addPano_post(@ModelAttribute("pa")panos pa,BindingResult result) {
		...
		pa.setNombrepano("PaÃƒÂ±o "+pa.getNumero());
            }
         ...
         return "redirect:verEstancias.htm?idE="+pa.getEstancia_id().getId();
    }
    
    
    
    @RequestMapping(value = "updatePano.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "updatePano.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "deletePano.htm",method=RequestMethod.GET)
    public String eliminarEstudio(@RequestParam(value = "idE") int idE,@RequestParam(value = "idP") int idP,ModelMap map) {
        ...
        return "redirect:verEstancias.htm?idE="+idE;
    }
    
    @RequestMapping("verPanos.htm")
    ...
    @RequestMapping("Presupuesto.htm")
    public String Presupuesto(@RequestParam(value = "idP") int idP,ModelMap map) {
        ...
        try{
            ...
            if(r==0){
                ...
                p=presupuestosService.porID(prem2.getIdpresupuesto());
    ...
    /*@RequestMapping("grupoPresupuesto.htm")
    ...
    public String asignarPlantilla(@RequestParam(value = "idE") int idE,@RequestParam(value = "idP") int idP,ModelMap map) {
        String rpta="";
        try{
            int id=plantillaPresupuestoService.existe(idE);
            if(id!=0){
        ...
        return "redirect:Presupuesto.htm?idP="+idP;  
    }*//*
    ...
    public String Plantilla(@RequestParam(value = "idE") int idE,@RequestParam(value = "idP") int idP,ModelMap map) {
        ...
        try{
            ...
            presupuestoc prec=new presupuestoc();
                    ...
                    System.out.println("idPresupC"+idPC);
             ...
             idPresC=idPC;
                if(rm2>0){
                    List<estancias> ltaSup=plantillaPresupuestoService.estanciasSuperficies(idP,idE);
                        for(estancias supP:ltaSup){
                            presupuesto_superficie ps=new presupuesto_superficie();
                            ps.setEstancia_id(supP);
                            ps.setPresupuesto_id(idPC);
                            //ps.setPano_id();
                            for(panos p :supP.getLtaPa()){
                                ps.setPano_id(p);
                                presupuestoSuperficiesService.Insert(ps);
                            }
    ...
    //add presupuesto
    @RequestMapping(value = "addPresupuesto.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "addPresupuesto.htm",method=RequestMethod.POST)
    public String addPresupuesto_post(ModelMap map,@ModelAttribute("presup")presupuestoc presupr,BindingResult result) {
        
        try{
            presupCap=presupr;
            System.out.println("prop"+presupCap.getPropuesta_id()+"capitulo: "+presupCap.getCap().getId()+"- "+presupCap.getCap().getNombre());
        }catch(Exception ex){            
        }
        
        //map.addAttribute("presup",presup);  
        return "redirect:addPresupuesto2.htm";
    }
    List<presupuestoJson> LtaPresupuestoCap=null;
    @RequestMapping("/jsonAddPresupCap.htm")
    ...
    @RequestMapping("/jsonDeletePresupCap.htm")
    ...
    @RequestMapping("/jsonAddPresupSubCap.htm")
    ...
    @RequestMapping("/jsonDeletePresupSubCap.htm")
    ...
    @RequestMapping("/jsonAddUpdMedida.htm")
    ...
    @RequestMapping(value = "addPresupuesto2.htm",method=RequestMethod.GET)
    public String addPresupuesto2_get(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idC")int idC) {
       ...
       // map.addAttribute("ltaCapitulos",ltaCapitulos);
        ...
        return "addPresupuesto2";
    }
    
    @RequestMapping(value = "/addPresupuesto2.htm")    
    public @ResponseBody String addPresupuesto2_post(@RequestBody List<presupuestoJson> presupuestoJ){
       String ruta="";
        try{
           ruta="/Intranet/sup/addPresupuesto3.htm";
           int rU=0;
           int rM=0;
          ...
          if(rU!=0){
              ...
              ruta="/Intranet/sup/addPresupuesto4.htm";
          }
       }catch(Exception ex){}
       return ruta;
    }
    ...
    @RequestMapping(value = "/addPresupuesto22.json", method = RequestMethod.POST)
    
    public @ResponseBody String addPresupuesto22_post(@RequestBody String jsonValue){
        System.out.println("Delete Expense Method--------------");
       System.out.println("Delete Expense Method--------------"+jsonValue);
         
       return "/Intranet/sup/addPresupuesto3.htm";
    }
    /*
    @RequestMapping(value = "addPresupuesto2.htm",method=RequestMethod.POST)
    public String addPresupuesto2_post(ModelMap map,@ModelAttribute("presup")presupuesto presup2,BindingResult result) {
        ...
        try{
            ...
            if(presup.getTipoCantidad().equals("und.")){
                redirec="redirect:addPresupuesto3.htm";
            }else{
                redirec="redirect:addPresupuesto4.htm";
            }
        }catch(Exception ex){            
        }
        //map.addAttribute("presup",presup);  
    ...
    @RequestMapping(value = "addPresupuesto3.htm",method=RequestMethod.GET)
    public String addPresupuesto3_get(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC) {
        ...
        try{
            ...
            if(presup.getTipoCantidad().equals("und.")){
                ruta="addPresupuesto3";            
                String r=validaInterfacesRoles.valida();
                map.addAttribute("menu",r);
                map.addAttribute("p",p);
                map.addAttribute("presup",presup);
            }else  ruta="redirect:addPresupuesto4.htm?idP="+idP+"&idPre="+idPre+"&idSC="+idSC; 
    ...
    int idPresC=0;
    @RequestMapping(value = "addPresupuesto3.htm",method=RequestMethod.POST)
    public String addPresupuesto3_post(ModelMap map,@ModelAttribute("presup")presupuesto presup2,BindingResult result) {
      // String ruta="redirect:Presupuesto.htm?idP="+presup2.getPropuesta_id();
        String ruta="redirect:addPresupuesto2.htm?idP="+presup2.getProp()+"&idC="+presup2.getCapitulo().getId();
        try{
           ...
           /*int rM=0;
            ...
            if(presupLta.size()!=0){
                presupuestoc prec=new presupuestoc();
                 prec.setPropuesta_id(presup2.getPropuesta_id());
               prec.setCapitulo_id(presup2.getCapitulo_id().getId());
                prec.setDescripcion(presup2.getDescripcion());
                prec.setCantidad(presup2.getCantidad());
            
            if(presupuestoCService.Insert(prec)==true){
                idPresC=presupuestoCService.ultimoPresupuestoC(prec.getPropuesta_id(), prec.getCapitulo_id());
            for(presupuestoJson p : presupLta){
                if(p.getTipoCantidad().equals("und.")){
                    subcapitulos s=subCapitulosService.porId(p.getIdSubCap());
                    presup2.setSubcapitulo(s);
                    presup2.setTipoCantidad("und.");
                    presup2.setPrecio(s.getCantidad());
                    presup2.setMonto(presup2.getCantidad()*presup2.getPrecio());
                    presup2.setPresup_id(idPresC);
                    //if(presupuestosService.buscar(presup2)==0){
                        presupuestosService.Insert(presup2);                
                    //}
                }else rM++;
            }
            if(rM!=0){
                ruta="redirect:addPresupuesto4.htm";
            }else{
            //presup=presup2;
            presup=new presupuesto();
            presupSupLista=new ArrayList<presupuesto_superficie>();
    ...
    @RequestMapping("addPresupuesto4.htm")
    public String addPresupuesto4(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC) {
        ...
        return("addPresupuesto4");
        
    }
   
    @RequestMapping("/jsonAddPresupEstanciaM2.htm")
    ...
    @RequestMapping("/jsonAddPresupEstanciaPanosM2.htm")
    ...
    @RequestMapping("/jsonAddPresupEstanciaPanosM2Largo.htm")
    ...
    @RequestMapping("/jsonDeletePresupEstanciaM2.htm")
    ...
    @RequestMapping("/jsonAddPresupVentanasM2.htm")
    ...
    @RequestMapping("/jsonAddPresupPuertasM2.htm")
    public @ResponseBody String jsonAddPresupPuertasM2(@RequestBody presupuesto_superficies_panos_vpa pre_sup ){
    ...
    @RequestMapping("/jsonAddPresupArmariosM2.htm")
    public @ResponseBody String jsonAddPresupArmariosM2(@RequestBody presupuesto_superficies_panos_vpa pre_sup ){
        ...
        try{
            ...
            int idpsp=presupuestoSuperficiesPanosService.buscaridPresupSup(pre_sup.getIdpresup_sup_pano());
            System.out.println("armario:"+idpsp);
            presupuesto_superficie pre=presupuestoSuperficiesService.porID(idpsp);
            presupuesto p=presupuestosService.porID(pre.getPresupuesto_id());
            if(p.getSubcapitulo().getId_capitulo().getId()==30 || p.getSubcapitulo().getId_capitulo().getId()==31){
                if("m2".equals(p.getTipoCantidad()))
    ...
    @RequestMapping("/jsonDeletePresupVentanasM2.htm")
    ...
    @RequestMapping("/jsonDeletePresupPuertasM2.htm")
    public @ResponseBody String jsonDeletePresupPuertasM2(@RequestBody presupuesto_superficies_panos_vpa pre_sup ){
       try{
            puertas v=puertasService.porID(pre_sup.getIdpuerta());
            int idpsp=presupuestoSuperficiesPanosService.buscaridPresupSup(pre_sup.getIdpresup_sup_pano());
            presupuesto_superficie pre=presupuestoSuperficiesService.porID(idpsp);
    ...
    @RequestMapping("/jsonDeletePresupArmariosM2.htm")
    public @ResponseBody String jsonDeletePresupArmariosM2(@RequestBody presupuesto_superficies_panos_vpa pre_sup ){
       try{
            armarios v=armariosService.porID(pre_sup.getIdarmario());
            int idpsp=presupuestoSuperficiesPanosService.buscaridPresupSup(pre_sup.getIdpresup_sup_pano());
            presupuesto_superficie pre=presupuestoSuperficiesService.porID(idpsp);
    ...
    @RequestMapping("/jsonDeletePresupEstanciaPanosM2.htm")
    public @ResponseBody String jsonDeletePresupEstanciaPanosM2(@RequestBody presupuesto_superficies_panos pre_sup ){
     ...
     @RequestMapping(value = "addPresupuesto5.htm",method=RequestMethod.GET)
    public String addPresupuesto5_get(ModelMap map,@RequestParam(value = "idE") int idE,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC,@RequestParam(value = "idPresup") int idPresup) {
        ...
        return("addPresupuesto5");
    }
   @RequestMapping(value = "addPresupuesto6.htm",method=RequestMethod.GET)
    public String addPresupuesto6_get(ModelMap map,@RequestParam(value = "idE") int idE,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC,@RequestParam(value = "idPresup") int idPresup,@RequestParam(value = "idPsp") int idPsp,@RequestParam(value = "idPano") int idPano) {
     ...
     try{
        ...
        return("addPresupuesto6");
    }
    @RequestMapping(value = "addPresupuesto7.htm",method=RequestMethod.GET)
    public String addPresupuesto7_get(ModelMap map,@RequestParam(value = "idPano") int idPano,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC) {
      ...
      /* sum=0;
        ...
        //map.addAttribute("presup",presup);  
        return "redirect:addPresupuesto5.htm?idE="+psup.getEstancia_id().getId()+"&idP="+idP+"&idPre="+idPre+"&idSC="+idSC;*/
      return "";
    }
    
    
      @RequestMapping(value = "addPresupuestoG.htm",method=RequestMethod.GET)
    public String addPresupuestoG_get(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC,@RequestParam(value="idPresup")int idPresup) {
       ...
       // List<subcapitulos> ltaSubCapitulos=null;
        try{
            ...
            if(s==0){
                ruta="redirect:addPresupuesto4.htm?idP="+idP+"&idPre="+idPre+"&idSC="+idSC;
            }else{
            estancias e=new estancias();
            e.setId(0);
            p=propuestasService.porId(idP);
    ...
    @RequestMapping(value = "addPresupuestoG.htm",method=RequestMethod.POST)
    public String addPresupuestoG_post(ModelMap map,@ModelAttribute("presup")presupuesto presup2,BindingResult result) {
        ...
        return "redirect:addPresupuesto2.htm?idP="+presup2.getProp()+"&idC="+presup2.getCapitulo().getId(); 
    }
    ...
    //update Presupuesto
    @RequestMapping(value = "updatePresupuesto.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "updatePresupuesto.htm",method=RequestMethod.POST)
    public String updatePresupuesto_post(ModelMap map,@ModelAttribute("presup")presupuesto presupr,BindingResult result) {
        ...
        return "redirect:updatePresupuesto2.htm";
    }
    int idPresUpd=0;
    int idPropUpd=0;
    @RequestMapping(value = "updatePresupuesto2.htm",method=RequestMethod.GET)
    public String updatePresupuesto2_get(ModelMap map,@RequestParam(value = "idPres") int idPres,@RequestParam(value = "idP") int idP) {
        ...
        return "updatePresupuesto2";
    }
    
    @RequestMapping(value = "/updatePresupuesto2.htm")    
    public @ResponseBody String updatePresupuesto2_post(@RequestBody List<presupuestoJson> presupuestoJ){
       String ruta="";
        try{
           ruta="/Intranet/sup/updatePresupuesto3.htm";
           int rU=0;
           int rM=0;
          for(presupuestoJson p : presupuestoJ){
              presupLta.add(p);
          ...
          if(rU!=0){
              ...
              ruta="/Intranet/sup/updatePresupuesto4.htm";
          }
       }catch(Exception ex){}
       return ruta;
    }
    /*
    @RequestMapping(value = "updatePresupuesto2.htm",method=RequestMethod.POST)
    public String updatePresupuesto2_post(ModelMap map,@ModelAttribute("presup")presupuesto presup2,BindingResult result) {
        ...
        try{
            ...
            if(presup2.getTipoCantidad().equals("und.")){
                redirec="redirect:updatePresupuesto3.htm";
            }else{
                redirec="redirect:updatePresupuesto4.htm";
            }
    ...
    @RequestMapping(value = "updatePresupuesto3.htm",method=RequestMethod.GET)
    public String updatePresupuesto3_get(ModelMap map) {
        ...
        return "updatePresupuesto3";
    }
    
    @RequestMapping(value = "updatePresupuesto3.htm",method=RequestMethod.POST)
    public String updatePresupuesto3_post(ModelMap map,@ModelAttribute("prec")presupuestoc presup2,BindingResult result) {
       String ruta="redirect:Presupuesto.htm?idP="+presup2.getPropuesta_id();
        try{
            ...
            if(rM!=0){
                ruta="redirect:updatePresupuesto4.htm";
            }else{
                presupuestoSuperficiesService.Delete(presup2.getId());
    ...
    @RequestMapping("updatePresupuesto4.htm")
    public String updatePresupuesto4(ModelMap map) {
        ...
        map.addAttribute("ltaEstancias",ltaEstancias);
        return("updatePresupuesto4");
        
    }
   
    
     @RequestMapping(value = "updatePresupuesto5.htm",method=RequestMethod.GET)
    public String updatePresupuesto5_get(ModelMap map,@RequestParam(value = "idE") int idE) {
        ...
        map.addAttribute("ltaPanos",ltaPanos);
        map.addAttribute("idE",idE);
        return("updatePresupuesto5");
    }
    
    @RequestMapping(value = "updatePresupuesto6.htm",method=RequestMethod.GET)
    public String updatePresupuesto6_get(ModelMap map,@RequestParam(value = "idPano") int idPano,@RequestParam(value = "idE") int idE) {
      /* presup.setCantidad(0);
        ...
        return "redirect:updatePresupuesto5.htm?idE="+psup.getEstancia_id().getId();*/
      return "";
    }
    
     @RequestMapping(value = "updatePresupuesto7.htm",method=RequestMethod.GET)
    public String updatePresupuesto7_get(ModelMap map,@RequestParam(value = "idPano") int idPano,@RequestParam(value = "idE") int idE) {
      ...
      @RequestMapping(value = "updatePresupuestoG.htm",method=RequestMethod.GET)
    public String updatePresupuestoG_get(ModelMap map,@RequestParam(value = "idE") int idE) {
        
        propuesta p=new propuesta();
        String ruta="updatePresupuestoG";
        try{
            ...
            if(s==0){
                ruta="redirect:updatePresupuesto5.htm?idE="+estancia.getId();
            }else{
                estancias e=new estancias();
                e.setId(0);
    ...
    @RequestMapping(value = "updatePresupuestoG.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "deletePresupuesto.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "asignarLtaGuardada.htm",method=RequestMethod.GET)
    public String asignarLtaGuardada(@RequestParam(value = "idP") int idP,@RequestParam(value = "idPre") int idPre,@RequestParam(value = "idSC") int idSC,ModelMap map) {
        ...
        return "redirect:addPresupuesto2.htm?idP="+idP+"&idC="+pres.getCapitulo().getId();  
    }
    
    @RequestMapping(value = "deletePresupuestoG.htm",method=RequestMethod.GET)
    public String eliminarPresupuestoG(@RequestParam(value = "idPres") int id,@RequestParam(value = "idP") int idP,@RequestParam(value = "idPP") int idPP,ModelMap map) {
        ...
        return "redirect:verPresupuesto.htm?idPres="+idPP+"&idP="+idP;  
    }
    
    @RequestMapping(value = "deletePresupuestoGCap.htm",method=RequestMethod.GET)
    ...
    @RequestMapping("verPresupuesto.htm")
    public String verPresupuesto(@RequestParam(value = "idPres") int idPres,@RequestParam(value = "idP") int idP,ModelMap map) {
        ...
        try{
           ...
           // if(presupues.getTipoCantidad().equals("und.")){
                ruta="verPresupuestoU";
            /*}else {
                
                List<presupuesto_superficie> ltapS=presupuestoSuperficiesService.findAll(idPres);
                List<estancias> ltaE=new ArrayList<estancias>();
                for(presupuesto_superficie p:ltapS){
                    ltaE.add(p.getEstancia_id());
                }
                map.addAttribute("ltaE",ltaE);
                map.addAttribute("presupSup",ltapS);
                ruta="verPresupuestoS";
            }*/
            //empleado=empleadoService.ByNif(nif); 
            //prop=propuestasService.porId(idP);
            //ltaEstancias=estanciasService.listaPropuesta(idP);
    ...
    @RequestMapping("verPresupuestoSC.htm")
    ...
    @RequestMapping(value = "contratarPresupuesto.htm",method=RequestMethod.GET)
    public String contratarPresupuesto(@RequestParam(value = "idP") int idPr,ModelMap map) {
        String rpta="";
        //String ruta="redirect:verNominas.htm";
        try{
        ...
        return "redirect:verPropuestas.htm?nifC="+nifCli.getNif();  
    }
    ...
    @RequestMapping(value = "verPresupuestoPdf.htm",method=RequestMethod.GET)
            ...
            if(res==true){
                ...
                prop=propuestasService.porId(idPr);
                   ...
                   String r=validaInterfacesRoles.valida();
                    ...
                    ruta="verPresupuestoPdf";
            }else{
                prop=propuestasService.porId(idPr);
                map.addAttribute("msg","error");
                ruta="redirect:verPropuestas.htm?nifC="+prop.getCliente_nif().getNif();
            }        
    ...
    @RequestMapping(value = "verPresupuestoDescuentoPdf.htm",method=RequestMethod.GET)
            ...
            if(res==true){
                ...
                prop=propuestasService.porId(idPr);
                   ...
                   String r=validaInterfacesRoles.valida();
                    map.addAttribute("menu",r);
                    map.addAttribute("idP",idPr);
                    ruta="verPresupuestoDescuentoPdf";
            }else{
                prop=propuestasService.porId(idPr);
                map.addAttribute("msg","error");
                ruta="redirect:verPropuestas.htm?nifC="+prop.getCliente_nif().getNif();
    ...
    @RequestMapping("pdfPresupuesto.htm")
    public ModelAndView pdf(ModelAndView mav,@RequestParam(value = "idP") int idPr){
        ...
        mav.setViewName("pdfPresupuesto");        
        return mav;
    }
    @RequestMapping("DescuentopdfPresupuesto.htm")
    public ModelAndView DescuentopdfPresupuesto(ModelAndView mav,@RequestParam(value = "idP") int idPr){
        propuesta prop=new propuesta();
        prop=propuestasService.porId(idPr);
        //ModelAndView mav=new ModelAndView();
        String r=validaInterfacesRoles.valida();
        mav.addObject("menu",r);
        mav.addObject("nif",prop.getCliente_nif().getNif());
        mav.setViewName("DescuentopdfPresupuesto");        
        return mav;
    }
    
    @RequestMapping(value = "RechazarPresupuesto.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "ActivarPresupuesto.htm",method=RequestMethod.GET)
    ...
    @RequestMapping("/PresupSupCap.json")    
    ...
    @RequestMapping(value="/jsonDescuentoPropuesta.json", method=RequestMethod.GET)
