...
@Controller
@RequestMapping("/emp/*")
public class EmpControllerPresupuestoExpresCocina {
    @Autowired
    ...
    @RequestMapping("/EPExpresaddCocina.htm")
...
@RequestMapping(value = "ENuevaPropuestaPExpresC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPExpres_get(ModelMap map,@RequestParam(value = "idE") int idE) {
        ...
        return "ENuevaPropuestaPExpresC";
    }
...
private void presupuesto1m2suelomas(presupuesto_expres pex,int cap,int subcap,int idsuelo) {
    ...
    private void presupuesto1m2pano2(presupuesto_expres pex, int c, int scap, int r) {
     ...
     @RequestMapping(value = "ENuevaPropuestaExpresC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaExpres_get(ModelMap map) {        
        ...
        return "ENuevaPropuestaExpresC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresAddC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaExpresAdd_get(ModelMap map,@RequestParam(value="cli")String nif) {        
        ...
        return "ENuevaPropuestaExpresAddC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresAddC.htm",method=RequestMethod.POST)
    public String NuevaPropuestaExpresAdd_post(@ModelAttribute("prop")propuesta prop,BindingResult result,Principal principal) {
        ...
        try{
         ...
         return "redirect:ENuevaPropuestaExpresEstanciasC.htm?idP="+id;
        
        
        
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresEstanciasC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaExpresEstancias_get(ModelMap map,@RequestParam(value="idP")int id) {        
        ...
        return "ENuevaPropuestaExpresEstanciasC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresEstanciasC.htm",method=RequestMethod.POST)
    public String NuevaPropuestaExpresEstancias_post(@ModelAttribute("estancia")estancias estan,BindingResult result) {
        ...
        try{
         ...
         return "redirect:ENuevaPropuestaExpresPanosC.htm?idE="+idE;
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresPanosC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaExpresPanos_get(ModelMap map,@RequestParam(value="idE")int idE) {        
        ...
        return "ENuevaPropuestaExpresPanosC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresPanosC.htm",method=RequestMethod.POST)
    public String NuevaPropuestaExpresPanos_post(@ModelAttribute("pa")panos pan,BindingResult result) {
        ...
        try{
            ...
            //e.setId(idE);
                    ...
                    if(pan.getTipo_pano_id().getId()!=1)ruta="redirect:ENuevaPropuestaExpresFinEstanciaC.htm?idE="+pan.getEstancia_id().getId();
                    else{
                        int idPan=panosService.idultimo(pan.getEstancia_id().getId());
                        ruta="redirect:ENuevaPropuestaExpresVentanasC.htm?idP="+idPan;
                    }
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresVentanasC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaExpresVentanas_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        map.addAttribute("menu",r);
        map.addAttribute("pa",pano);
        return "ENuevaPropuestaExpresVentanasC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresVentanasC.htm",method=RequestMethod.POST)
    public String NuevaPropuestaExpresVentanas_post(@ModelAttribute("pa")panos p,BindingResult result) {
        ...
        try{
            ...
            if(p.getVentana().equals("SI")){
                ruta="redirect:ENuevaPropuestaExpresVentanasFC.htm?idP="+p.getId();
            }else ruta="redirect:ENuevaPropuestaExpresPuertasC.htm?idP="+p.getId();
        }catch(Exception ex){}  
         return ruta;
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresVentanasFC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaVentanasF_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        return "ENuevaPropuestaExpresVentanasFC";
    }
    @RequestMapping(value = "ENuevaPropuestaExpresVentanasFC.htm",method=RequestMethod.POST)
    public String addVentanasF_post(@ModelAttribute("vent")ventanas v,BindingResult result) {
        String ruta="redirect:ENuevaPropuestaExpresVentanasFC.htm?idP="+v.getIdpano().getId();
        List<ventanas> ltaventana=null;
        try{
            //vent=v;
            ...
            if(pano.getNumventanas()==ltaventana.size()){
                ruta="redirect:ENuevaPropuestaExpresPuertasC.htm?idP="+pano.getId();
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresPuertasC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPuertas_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        map.addAttribute("menu",r);
        map.addAttribute("pa",pano);
        return "ENuevaPropuestaExpresPuertasC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresPuertasC.htm",method=RequestMethod.POST)
    public String NuevaPropuestaPuertas_post(@ModelAttribute("pa")panos p,BindingResult result) {
        ...
        try{
            ...
            if(p.getPuertas().equals("SI")){
                ruta="redirect:ENuevaPropuestaExpresPuertasFC.htm?idP="+p.getId();
            }else ruta="redirect:ENuevaPropuestaExpresArmariosC.htm?idP="+p.getId();
        }catch(Exception ex){}  
         return ruta;
    }
    @RequestMapping(value = "ENuevaPropuestaExpresPuertasFC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPuertasF_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        return "ENuevaPropuestaExpresPuertasFC";
    }
    @RequestMapping("/EExpresjsonNuevaPropuestaEjaddPuertasFC.htm")
    public @ResponseBody String ExpresjsonNuevaPropuestaEjaddPuertasF(@RequestBody puertas p ){
        ...
        String ruta="/Intranet/emp/ENuevaPropuestaExpresPuertasFC.htm?idP="+p.getId_pano();
        try{
            ...
            if(pano.getNumpuertas()==ltapuerta.size()){
                ruta="/Intranet/emp/ENuevaPropuestaExpresArmariosC.htm?idP="+p.getId_pano();
            }
        }catch(Exception ex){}
        return ruta; 
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresArmariosC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPuertasExpresArmarios_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        map.addAttribute("menu",r);
        map.addAttribute("pa",pano);
        return "ENuevaPropuestaExpresArmariosC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresArmariosC.htm",method=RequestMethod.POST)
    public String NuevaPropuestaPuertasExpresArmarios_post(@ModelAttribute("pa")panos p,BindingResult result) {
        ...
        try{
            ...
            if(p.getArmario().equals("SI")){
                ruta="redirect:ENuevaPropuestaExpresArmariosFC.htm?idP="+p.getId();
            }else ruta="redirect:ENuevaPropuestaExpresFinEstanciaC.htm?idE="+pa.getEstancia_id().getId();
        }catch(Exception ex){}  
         return ruta;
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresArmariosFC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaArmariosF_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        return "ENuevaPropuestaExpresArmariosFC";
    }
    @RequestMapping(value = "ENuevaPropuestaExpresArmariosFC.htm",method=RequestMethod.POST)
    public String NuevaPropuestaArmariosF_post(@ModelAttribute("arm")armarios v,BindingResult result) {
        String ruta="redirect:ENuevaPropuestaExpresArmariosFC.htm?idP="+v.getIdpano().getId();
        List<armarios> ltaarmario=null;
        try{
            //vent=v;
            panos pano=panosService.porID(v.getIdpano().getId());
            ...
            if(pano.getNumarmarios()==ltaarmario.size()){
                ruta="redirect:ENuevaPropuestaExpresFinEstanciaC.htm?idE="+pano.getEstancia_id().getId();
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresFinEstanciaC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaFinEstancia_get(ModelMap map,@RequestParam(value="idE")int idE) {
        ...
        map.addAttribute("idP",est.getPropuesta_id().getId());
        return "ENuevaPropuestaExpresFinEstanciaC";
    }
    
    
    @RequestMapping(value = "ENuevaPropuestaExpresFinPropuesta2C.htm",method=RequestMethod.GET)
    public String NuevaPropuestaFinPropuesta2(ModelMap map,@RequestParam(value="idE")int idE) {
        ...
        return "redirect:ENuevaPropuestaExpresVerPanosC.htm?idE="+idE;
    }
    
    
    
     @RequestMapping("ENuevaPropuestaExpresVerPanosC.htm")
    public String NuevaPropuestaVerPanos(@RequestParam(value = "idE") int idE,ModelMap map) {
        ...
        map.addAttribute("ltaPanos",ltaPanos);
        return("ENuevaPropuestaExpresVerPanosC");
        
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresDeleteEstanciaC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaDeleteEstancia(@RequestParam(value = "idE") int idE,@RequestParam(value = "idP") int idP,ModelMap map) {
        ...
        return "redirect:ENuevaPropuestaExpresVerEstanciaC.htm?idP="+idP;
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresDeletePanoC.htm",method=RequestMethod.GET)
    ...
    @RequestMapping("ENuevaPropuestaExpresVerPC.htm")
    public String verPanos(@RequestParam(value = "idPano") int idPano,ModelMap map) {
        ...
        return("ENuevaPropuestaExpresVerPC");
        
    }
    
    
    @RequestMapping(value = "ENuevaPropuestaExpresvolcarPanoC.htm",method=RequestMethod.GET)
    public String NuevaPropuestavolcarPano(@RequestParam(value = "idPano") int idPano,ModelMap map) {
        ...
        return "redirect:ENuevaPropuestaExpresVerPanosC.htm?idE="+pano2.getEstancia_id().getId();
    }
 
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdatePanoC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdatePano_get(ModelMap map,@RequestParam(value = "idP") int idPano) {
        ...
        return "ENuevaPropuestaExpresUpdatePanoC";
    }
    
     @RequestMapping(value = "ENuevaPropuestaExpresUpdatePanoC.htm",method=RequestMethod.POST)
    public String updatePano_post(@ModelAttribute("pa")panos pan,BindingResult result) {
        String ruta="redirect:ENuevaPropuestaExpresUpdateVentanasC.htm?idP="+pan.getId();
        List<panos> ltapanos=null;
                    ...
                    if(pan.getTipo_pano_id().getId()!=1){
                        ...
                        ruta="redirect:ENuevaPropuestaExpresVerPanosC.htm?idE="+pan.getEstancia_id().getId();
                    }else{ 
                        pan.setTotal(pan.getSuperficie());
                        panosService.Update(pan);
                    }
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresUpdateVentanasC.htm",method=RequestMethod.GET)
    public String EjupdateVentanas_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        map.addAttribute("ltaventana",ltaventana);
        return "ENuevaPropuestaExpresUpdateVentanasC";
    }
    
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdateVentanasFC.htm",method=RequestMethod.GET)
    public String EjupdateVentanasF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "ENuevaPropuestaExpresUpdateVentanasFC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdateVentanasFC.htm",method=RequestMethod.POST)
    public String EjupdateVentanasF_post(@ModelAttribute("vent")ventanas v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:ENuevaPropuestaExpresUpdateVentanasC.htm?idP="+v.getIdpano().getId()+"";
    }
     @RequestMapping(value = "ENuevaPropuestaExpresUpdateVentanasFaddC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdateVentanasFadd_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "ENuevaPropuestaExpresUpdateVentanasFaddC";
    }
    @RequestMapping(value = "ENuevaPropuestaExpresUpdateVentanasFaddC.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresDeleteVentanasC.htm",method=RequestMethod.GET)
    public String EjdeleteVentanas(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:ENuevaPropuestaExpresUpdateVentanasC.htm?idP="+ventana.getIdpano().getId()+"";
    }
    //puertas
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdatePuertasC.htm",method=RequestMethod.GET)
    public String EjupdatePuertas_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        map.addAttribute("idPano",id);
        map.addAttribute("ltapuerta",ltapuerta);
        return "ENuevaPropuestaExpresUpdatePuertasC";
    }
    
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdatePuertasFC.htm",method=RequestMethod.GET)
    public String EjupdatePuertasF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "ENuevaPropuestaExpresUpdatePuertasFC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdatePuertasFC.htm",method=RequestMethod.POST)
    public String EjupdatePuertasF_post(@ModelAttribute("pu")puertas v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:ENuevaPropuestaExpresUpdatePuertasC.htm?idP="+v.getIdpano().getId()+"";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdatePuertasFaddC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdatePuertasFadd_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "ENuevaPropuestaExpresUpdatePuertasFaddC";
    }
    @RequestMapping(value = "ENuevaPropuestaExpresUpdatePuertasFaddC.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresDeletePuertasC.htm",method=RequestMethod.GET)
    public String EjdeletePuertas(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:ENuevaPropuestaExpresUpdatePuertasC.htm?idP="+p.getIdpano().getId()+"";
    }
    
    //armarios
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdateArmarioC.htm",method=RequestMethod.GET)
    public String EjupdateArmario_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        map.addAttribute("idPano",id);
        map.addAttribute("ltaarmario",ltaarmario);
        return "ENuevaPropuestaExpresUpdateArmarioC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdateArmarioFC.htm",method=RequestMethod.GET)
    public String EjupdateArmarioF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "ENuevaPropuestaExpresUpdateArmarioFC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdateArmarioFC.htm",method=RequestMethod.POST)
    public String EjupdateArmarioF_post(@ModelAttribute("arm")armarios v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:ENuevaPropuestaExpresUpdateArmarioC.htm?idP="+v.getIdpano().getId()+"";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresUpdateArmarioFaddC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdateArmarioFadd_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "ENuevaPropuestaExpresUpdateArmarioFaddC";
    }
    @RequestMapping(value = "ENuevaPropuestaExpresUpdateArmarioFaddC.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresDeleteArmarioC.htm",method=RequestMethod.GET)
    public String EjdeleteArmario(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:ENuevaPropuestaExpresUpdateArmarioC.htm?idP="+p.getIdpano().getId()+"";
    }
    @RequestMapping(value = "ENuevaPropuestaExpresUpdateFinishC.htm",method=RequestMethod.GET)
    public String EjupdateFinish(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "redirect:ENuevaPropuestaExpresVerPanosC.htm?idE="+est.getId();
    }
