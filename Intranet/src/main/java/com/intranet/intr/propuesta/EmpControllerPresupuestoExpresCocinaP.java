...
@Controller
@RequestMapping("/emp/*")
public class EmpControllerPresupuestoExpresCocinaP {
    @Autowired
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresPresupuestoC.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPresupuesto_get(ModelMap map,@RequestParam(value = "idP") int idP,@RequestParam(value = "msg", required = false) String msg) {        
        ...
        return "ENuevaPropuestaExpresPresupuestoC";
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresPresupuesto2C.htm",method=RequestMethod.GET)
    public String addPresupuestoExpres2_get(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idC")int idC) {
       ...
       // map.addAttribute("ltaCapitulos",ltaCapitulos);
        ...
        return "ENuevaPropuestaExpresPresupuesto2C";
    }
   
    
    @RequestMapping(value = "ENuevaPropuestaExpresPresupuesto3C.htm",method=RequestMethod.GET)
    public String addPresupuesto3_get(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC) {
        ...
        try{
            ...
            if(presup.getTipoCantidad().equals("und.")){
                ruta="ENuevaPropuestaExpresPresupuesto3C";            
                String r=validaInterfacesRoles.valida();
                map.addAttribute("menu",r);
                map.addAttribute("p",p);
                map.addAttribute("presup",presup);
            }else  ruta="redirect:ENuevaPropuestaExpresPresupuesto4C.htm?idP="+idP+"&idPre="+idPre+"&idSC="+idSC; 
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresPresupuesto3C.htm",method=RequestMethod.POST)
    public String addPresupuesto3_post(ModelMap map,@ModelAttribute("presup")presupuesto presup2,BindingResult result) {
      // String ruta="redirect:Presupuesto.htm?idP="+presup2.getPropuesta_id();
        String ruta="redirect:ENuevaPropuestaExpresPresupuesto2C.htm?idP="+presup2.getProp()+"&idC="+presup2.getCapitulo().getId();
        try{
    ...
    @RequestMapping("ENuevaPropuestaExpresPresupuesto4C.htm")
    public String addPresupuesto4(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC) {
        ...
        return("ENuevaPropuestaExpresPresupuesto4C");
        
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresPresupuesto5C.htm",method=RequestMethod.GET)
    public String addPresupuesto5_get(ModelMap map,@RequestParam(value = "idE") int idE,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC,@RequestParam(value = "idPresup") int idPresup) {
        ...
        return("ENuevaPropuestaExpresPresupuesto5C");
    }
    @RequestMapping(value = "ENuevaPropuestaExpresPresupuesto6C.htm",method=RequestMethod.GET)
    public String addPresupuesto6_get(ModelMap map,@RequestParam(value = "idE") int idE,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC,@RequestParam(value = "idPresup") int idPresup,@RequestParam(value = "idPsp") int idPsp,@RequestParam(value = "idPano") int idPano) {
     ...
     try{
        ...
        return("ENuevaPropuestaExpresPresupuesto6C");
    }
    @RequestMapping(value = "ENuevaPropuestaExpresPresupuestoGC.htm",method=RequestMethod.GET)
    public String addPresupuestoG_get(ModelMap map,@RequestParam(value="idP")int idP,@RequestParam(value="idPre")int idPre,@RequestParam(value="idSC")int idSC,@RequestParam(value="idPresup")int idPresup) {
        String ruta="ENuevaPropuestaExpresPresupuestoGC";
        propuesta p=new propuesta();
        //List<capitulos> ltaCapitulos=null;
       // List<subcapitulos> ltaSubCapitulos=null;
        try{
            ...
            if(s==0){
                ruta="redirect:ENuevaPropuestaExpresPresupuesto4C.htm?idP="+idP+"&idPre="+idPre+"&idSC="+idSC;
           }else{
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresPresupuestoGC.htm",method=RequestMethod.POST)
    public String addPresupuestoG_post(ModelMap map,@ModelAttribute("presup")presupuesto presup2,BindingResult result) {
        ...
        return "redirect:ENuevaPropuestaExpresPresupuesto2C.htm?idP="+presup2.getProp()+"&idC="+presup2.getCapitulo().getId(); 
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresPresupuestoasignarLtaGuardadaC.htm",method=RequestMethod.GET)
    public String asignarLtaGuardada(@RequestParam(value = "idP") int idP,@RequestParam(value = "idPre") int idPre,@RequestParam(value = "idSC") int idSC,ModelMap map) {
        ...
        return "redirect:ENuevaPropuestaExpresPresupuesto2C.htm?idP="+idP+"&idC="+pres.getCapitulo().getId();  
    }
    
    @RequestMapping(value = "ENuevaPropuestaExpresVerPresupuestoCPdf.htm",method=RequestMethod.GET)
            ...
            if(res==true){
                ...
                prop=propuestasService.porId(idPr);
                   ...
                   String r=validaInterfacesRoles.valida();
                    ...
                    ruta="ENuevaPropuestaExpresVerPresupuestoCPdf";
            }else{
                prop=propuestasService.porId(idPr);
                map.addAttribute("msg","error");
                ruta="redirect:ENuevaPropuestaExpresPresupuestoC.htm?idP="+idPr;
            }        
    ...
    @RequestMapping(value = "ENuevaPropuestaExpresenviarPresupuestoC.htm",method=RequestMethod.GET)
    public String enviarPresupuesto(@RequestParam(value = "idP") int idPr,ModelMap map) {
        ...
        return "redirect:ENuevaPropuestaExpresPresupuestoC.htm?idP="+idPr;
    }
}
