...
@Controller
@RequestMapping("/sup/*")
public class SupControllerPropuestaPasoP {
    @Autowired
    ...
    @RequestMapping(value = "NuevaPropuesta.htm",method=RequestMethod.GET)
    ...
    @RequestMapping("/jsonAddClientePasoPropuesta.htm")
    public @ResponseBody String jsonAddClientePasoPropuesta(@RequestBody clientes c ){
        ...
        return "/Intranet/sup/NuevaPropuestaAdd.htm?cli="+c.getNif(); 
    }
    
    @RequestMapping(value = "NuevaPropuestaAdd.htm",method=RequestMethod.GET)
    public String NuevaPropuestaAdd_get(ModelMap map,@RequestParam(value="cli")String nif) {        
        ...
        return "NuevaPropuestaAdd";
    }
    
    @RequestMapping(value = "NuevaPropuestaAdd.htm",method=RequestMethod.POST)
    public String NuevaPropuestaAdd_post(@ModelAttribute("prop")propuesta prop,BindingResult result,Principal principal) {
        ...
        try{
         ...
         return "redirect:NuevaPropuestaEstancias.htm?idP="+id;
        
        
        
    }
    @RequestMapping(value = "NuevaPropuestaEstancias.htm",method=RequestMethod.GET)
    public String NuevaPropuestaEstancias_get(ModelMap map,@RequestParam(value="idP")int id) {        
        ...
        return "NuevaPropuestaEstancias";
    }
    
    @RequestMapping(value = "NuevaPropuestaEstancias.htm",method=RequestMethod.POST)
    public String NuevaPropuestaEstancias_post(@ModelAttribute("estancia")estancias estan,BindingResult result) {
        ...
        try{
         ...
         return "redirect:NuevaPropuestaPanos.htm?idE="+idE;
    }
    
    @RequestMapping(value = "NuevaPropuestaPanos.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPanos_get(ModelMap map,@RequestParam(value="idE")int idE) {        
        ...
        return "NuevaPropuestaPanos";
    }
    
    @RequestMapping(value = "NuevaPropuestaPanos.htm",method=RequestMethod.POST)
    public String NuevaPropuestaPanos_post(@ModelAttribute("pa")panos pan,BindingResult result) {
        ...
        try{
            ...
            //e.setId(idE);
                    ...
                    if(pan.getTipo_pano_id().getId()!=1)ruta="redirect:NuevaPropuestaFinEstancia.htm?idE="+pan.getEstancia_id().getId();
                    else{
                        int idPan=panosService.idultimo(pan.getEstancia_id().getId());
                        ruta="redirect:NuevaPropuestaVentanas.htm?idP="+idPan;
                    }
    ...
    @RequestMapping(value = "NuevaPropuestaVentanas.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "NuevaPropuestaVentanas.htm",method=RequestMethod.POST)
    public String NuevaPropuestaVentanas_post(@ModelAttribute("pa")panos p,BindingResult result) {
        ...
        try{
            ...
            if(p.getVentana().equals("SI")){
                ruta="redirect:NuevaPropuestaVentanasF.htm?idP="+p.getId();
            }else ruta="redirect:NuevaPropuestaPuertas.htm?idP="+p.getId();
        }catch(Exception ex){}  
         return ruta;
    }
    @RequestMapping(value = "NuevaPropuestaVentanasF.htm",method=RequestMethod.GET)
    public String NuevaPropuestaVentanasF_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        return "NuevaPropuestaVentanasF";
    }
    @RequestMapping(value = "NuevaPropuestaVentanasF.htm",method=RequestMethod.POST)
    public String addVentanasF_post(@ModelAttribute("vent")ventanas v,BindingResult result) {
        String ruta="redirect:NuevaPropuestaVentanasF.htm?idP="+v.getIdpano().getId();
        List<ventanas> ltaventana=null;
        try{
            //vent=v;
            ...
            if(pano.getNumventanas()==ltaventana.size()){
                ruta="redirect:NuevaPropuestaPuertas.htm?idP="+pano.getId();
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "NuevaPropuestaPuertas.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPuertas_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        map.addAttribute("menu",r);
        map.addAttribute("pa",pano);
        return "NuevaPropuestaPuertas";
    }
    
    @RequestMapping(value = "NuevaPropuestaPuertas.htm",method=RequestMethod.POST)
    public String NuevaPropuestaPuertas_post(@ModelAttribute("pa")panos p,BindingResult result) {
        ...
        try{
            ...
            if(p.getPuertas().equals("SI")){
                ruta="redirect:NuevaPropuestaPuertasF.htm?idP="+p.getId();
            }else ruta="redirect:NuevaPropuestaArmarios.htm?idP="+p.getId();
        }catch(Exception ex){}  
         return ruta;
    }
    @RequestMapping(value = "NuevaPropuestaPuertasF.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPuertasF_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        return "NuevaPropuestaPuertasF";
    }
    
    @RequestMapping("/jsonNuevaPropuestaEjaddPuertasF.htm")
    public @ResponseBody String jsonNuevaPropuestaEjaddPuertasF(@RequestBody puertas p ){
        System.out.println("add json puertas");
        String ruta="/Intranet/sup/NuevaPropuestaPuertasF.htm?idP="+p.getId_pano();
        try{
            ...
            if(pano.getNumpuertas()==ltapuerta.size()){
                ruta="/Intranet/sup/NuevaPropuestaArmarios.htm?idP="+p.getId_pano();
            }
        }catch(Exception ex){}
        return ruta; 
    }
    
    @RequestMapping(value = "NuevaPropuestaArmarios.htm",method=RequestMethod.GET)
    public String NuevaPropuestaPuertasArmarios_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        map.addAttribute("menu",r);
        map.addAttribute("pa",pano);
        return "NuevaPropuestaArmarios";
    }
    
    @RequestMapping(value = "NuevaPropuestaArmarios.htm",method=RequestMethod.POST)
    public String NuevaPropuestaPuertasArmarios_post(@ModelAttribute("pa")panos p,BindingResult result) {
        ...
        try{
            ...
            if(p.getArmario().equals("SI")){
                ruta="redirect:NuevaPropuestaArmariosF.htm?idP="+p.getId();
            }else ruta="redirect:NuevaPropuestaFinEstancia.htm?idE="+pa.getEstancia_id().getId();
        }catch(Exception ex){}  
         return ruta;
    }
    
     @RequestMapping(value = "NuevaPropuestaArmariosF.htm",method=RequestMethod.GET)
    public String NuevaPropuestaArmariosF_get(ModelMap map,@RequestParam(value="idP")int idP) {        
        ...
        return "NuevaPropuestaArmariosF";
    }
    @RequestMapping(value = "NuevaPropuestaArmariosF.htm",method=RequestMethod.POST)
    public String NuevaPropuestaArmariosF_post(@ModelAttribute("arm")armarios v,BindingResult result) {
        String ruta="redirect:NuevaPropuestaArmariosF.htm?idP="+v.getIdpano().getId();
        List<armarios> ltaarmario=null;
        try{
            //vent=v;
            panos pano=panosService.porID(v.getIdpano().getId());
            ...
            if(pano.getNumarmarios()==ltaarmario.size()){
                ruta="redirect:NuevaPropuestaFinEstancia.htm?idE="+pano.getEstancia_id().getId();
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "NuevaPropuestaFinEstancia.htm",method=RequestMethod.GET)
    public String NuevaPropuestaFinEstancia_get(ModelMap map,@RequestParam(value="idE")int idE) {
        ...
        return "NuevaPropuestaFinEstancia";
    }
    
    @RequestMapping(value = "NuevaPropuestaFinPropuesta.htm",method=RequestMethod.GET)
    public String NuevaPropuestaFinPropuesta(ModelMap map,@RequestParam(value="idE")int idE) {
        ...
        return "redirect:NuevaPropuestaEstancias.htm?idP="+est.getPropuesta_id().getId();
    }
    
    @RequestMapping(value = "NuevaPropuestaFinPropuesta2.htm",method=RequestMethod.GET)
    public String NuevaPropuestaFinPropuesta2(ModelMap map,@RequestParam(value="idE")int idE) {
        ...
        String ruta= "";
            ...
            //estancia.add(est);
                ...
                estanciasService.Update(est);
        return "redirect:NuevaPropuestaVerEstancia.htm?idP="+est.getPropuesta_id().getId();
    }
    
    @RequestMapping("NuevaPropuestaVerEstancia.htm")
    public String NuevaPropuestaVerEstancia(@RequestParam(value = "idP") int idP,ModelMap map) {
        ...
        return("NuevaPropuestaVerEstancia");
        
    }
    
     @RequestMapping("NuevaPropuestaVerPanos.htm")
    public String NuevaPropuestaVerPanos(@RequestParam(value = "idE") int idE,ModelMap map) {
        ...
        return("NuevaPropuestaVerPanos");
        
    }
    
    @RequestMapping(value = "NuevaPropuestaDeleteEstancia.htm",method=RequestMethod.GET)
    public String NuevaPropuestaDeleteEstancia(@RequestParam(value = "idE") int idE,@RequestParam(value = "idP") int idP,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaVerEstancia.htm?idP="+idP;
    }
    
    @RequestMapping(value = "NuevaPropuestaDeletePano.htm",method=RequestMethod.GET)
    public String eliminarEstudio(@RequestParam(value = "idE") int idE,@RequestParam(value = "idP") int idP,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaVerPanos.htm?idE="+idE;
    }
    
    @RequestMapping("NuevaPropuestaVerP.htm")
    public String verPanos(@RequestParam(value = "idPano") int idPano,ModelMap map) {
        ...
        return("NuevaPropuestaVerP");
        
    }
    
    
    @RequestMapping(value = "NuevaPropuestavolcarPano.htm",method=RequestMethod.GET)
    public String NuevaPropuestavolcarPano(@RequestParam(value = "idPano") int idPano,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaVerPanos.htm?idE="+pano2.getEstancia_id().getId();
    }
    
    @RequestMapping(value = "NuevaPropuestaUpdatePano.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdatePano_get(ModelMap map,@RequestParam(value = "idP") int idPano) {
        ...
        return "NuevaPropuestaUpdatePano";
    }
    
     @RequestMapping(value = "NuevaPropuestaUpdatePano.htm",method=RequestMethod.POST)
    public String updatePano_post(@ModelAttribute("pa")panos pan,BindingResult result) {
        String ruta="redirect:NuevaPropuestaUpdateVentanas.htm?idP="+pan.getId();
        List<panos> ltapanos=null;
                    ...
                    if(pan.getTipo_pano_id().getId()!=1){
                        ...
                        ruta="redirect:NuevaPropuestaVerPanos.htm?idE="+pan.getEstancia_id().getId();
                    }else{ 
                        pan.setTotal(pan.getSuperficie());
                        panosService.Update(pan);
                    }
    ...
    @RequestMapping(value = "NuevaPropuestaUpdateVentanas.htm",method=RequestMethod.GET)
    public String EjupdateVentanas_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        map.addAttribute("ltaventana",ltaventana);
        return "NuevaPropuestaUpdateVentanas";
    }
    
    
    @RequestMapping(value = "NuevaPropuestaUpdateVentanasF.htm",method=RequestMethod.GET)
    public String EjupdateVentanasF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "NuevaPropuestaUpdateVentanasF";
    }
    
    @RequestMapping(value = "NuevaPropuestaUpdateVentanasF.htm",method=RequestMethod.POST)
    public String EjupdateVentanasF_post(@ModelAttribute("vent")ventanas v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:NuevaPropuestaUpdateVentanas.htm?idP="+v.getIdpano().getId()+"";
    }
     @RequestMapping(value = "NuevaPropuestaUpdateVentanasFadd.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdateVentanasFadd_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "NuevaPropuestaUpdateVentanasFadd";
    }
    @RequestMapping(value = "NuevaPropuestaUpdateVentanasFadd.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "NuevaPropuestaDeleteVentanas.htm",method=RequestMethod.GET)
    public String EjdeleteVentanas(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaUpdateVentanas.htm?idP="+ventana.getIdpano().getId()+"";
    }
    //puertas
    
    @RequestMapping(value = "NuevaPropuestaUpdatePuertas.htm",method=RequestMethod.GET)
    public String EjupdatePuertas_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        map.addAttribute("idPano",id);
        map.addAttribute("ltapuerta",ltapuerta);
        return "NuevaPropuestaUpdatePuertas";
    }
    
    
    @RequestMapping(value = "NuevaPropuestaUpdatePuertasF.htm",method=RequestMethod.GET)
    public String EjupdatePuertasF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "NuevaPropuestaUpdatePuertasF";
    }
    
    @RequestMapping(value = "NuevaPropuestaUpdatePuertasF.htm",method=RequestMethod.POST)
    public String EjupdatePuertasF_post(@ModelAttribute("pu")puertas v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:NuevaPropuestaUpdatePuertas.htm?idP="+v.getIdpano().getId()+"";
    }
    
    @RequestMapping(value = "NuevaPropuestaUpdatePuertasFadd.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdatePuertasFadd_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "NuevaPropuestaUpdatePuertasFadd";
    }
    @RequestMapping(value = "NuevaPropuestaUpdatePuertasFadd.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "NuevaPropuestaDeletePuertas.htm",method=RequestMethod.GET)
    public String EjdeletePuertas(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaUpdatePuertas.htm?idP="+p.getIdpano().getId()+"";
    }
    
    //armarios
    
    @RequestMapping(value = "NuevaPropuestaUpdateArmario.htm",method=RequestMethod.GET)
    public String EjupdateArmario_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        map.addAttribute("idPano",id);
        map.addAttribute("ltaarmario",ltaarmario);
        return "NuevaPropuestaUpdateArmario";
    }
    
    @RequestMapping(value = "NuevaPropuestaUpdateArmarioF.htm",method=RequestMethod.GET)
    public String EjupdateArmarioF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "NuevaPropuestaUpdateArmarioF";
    }
    
    @RequestMapping(value = "NuevaPropuestaUpdateArmarioF.htm",method=RequestMethod.POST)
    public String EjupdateArmarioF_post(@ModelAttribute("arm")armarios v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:NuevaPropuestaUpdateArmario.htm?idP="+v.getIdpano().getId()+"";
    }
    
    @RequestMapping(value = "NuevaPropuestaUpdateArmarioFadd.htm",method=RequestMethod.GET)
    public String NuevaPropuestaUpdateArmarioFadd_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "NuevaPropuestaUpdateArmarioFadd";
    }
    @RequestMapping(value = "NuevaPropuestaUpdateArmarioFadd.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "NuevaPropuestaDeleteArmario.htm",method=RequestMethod.GET)
    public String EjdeleteArmario(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:NuevaPropuestaUpdateArmario.htm?idP="+p.getIdpano().getId()+"";
    }
    @RequestMapping(value = "NuevaPropuestaUpdateFinish.htm",method=RequestMethod.GET)
    public String EjupdateFinish(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "redirect:NuevaPropuestaVerPanos.htm?idE="+est.getId();
    }
