...
@Controller
@RequestMapping("/emp/*")
public class EmpControllerClientes {
    @Autowired
    ...
    public ModelAndView DocumentosContratosList(ModelAndView mav){
        ...
        mav.setViewName("EClientes");        
        return mav;
    }
    
    @RequestMapping(value = "EaddDatosCliente.htm",method=RequestMethod.GET)
    public String addCliente_get(ModelMap map) {
        ...
        return "EaddDatosCliente";
    }
    
    @RequestMapping(value = "EaddDatosCliente.htm",method=RequestMethod.POST)
    public String addCliente_post(@ModelAttribute("cliente")clientes cliente,BindingResult result) {
        ...
        try{
         ...
         return "redirect:EClientes.htm";
        
    }
    
    
    @RequestMapping(value = "EupdateDatosCliente.htm",method=RequestMethod.GET)
    public String updateDatosCliente_get(ModelMap map,@RequestParam(value = "nif") String nif) {
        ...
        return "EupdateDatosCliente";
    }
    
    @RequestMapping(value = "EupdateDatosCliente.htm",method=RequestMethod.POST)
    public String updateDatosCliente_post(@ModelAttribute("cliente")clientes cliente,BindingResult result) {
        ...
        try{
            ...
            users ue=new users();
                            ue.setNif(cliente.getNif());
                            ue.setEmail(cliente.getEmail());
    ...
    @RequestMapping(value = "EdeleteDatosCliente.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "EsecurityDatosCliente.htm",method=RequestMethod.GET)
    public String securityDatosCliente_get(ModelMap map,@RequestParam(value = "nif") String nif) {
        ...
        return "EsecurityDatosCliente";
    }
    
    @RequestMapping(value = "EsecurityDatosCliente.htm",method=RequestMethod.POST)
    ...
    @RequestMapping("EfichaCliente.htm")
    public String verPropuestas(@RequestParam(value = "nifC") String nif,@RequestParam(value = "msg", required = false) String msg,ModelMap map,Principal principal) {
        ...
        try{
            ...
            ltaProyectos=propuestasService.filtroCEProy(u.getNif(),nif);
            c=clientesService.ByNif(nif);
        }catch(Exception ex){
        ex.printStackTrace();
        ...
        return("EfichaCliente");
        
    }
    
    @RequestMapping("EfichaverPropuesta.htm")
	...
	float TotalStechos=0;
        ...
        return("EfichaverPropuesta");
        
    }
    
     @RequestMapping(value = "EFichaverPresupuestoPdf.htm",method=RequestMethod.GET)
            ...
            if(ltaP.size()!=0){
                ...
                prop=propuestasService.porId(idPr);
                   ...
                   String r=validaInterfacesRoles.valida();
                    ...
                    ruta="EFichaverPresupuestoPdf";
            }else{
                prop=propuestasService.porId(idPr);
                map.addAttribute("msg","error");
                ruta="redirect:EfichaCliente.htm?nifC="+prop.getCliente_nif().getNif();
            }        
        }catch(Exception e){
    ...
    @RequestMapping("EFichapdfPresupuestoPdf.htm")
    public ModelAndView pdf(ModelAndView mav,@RequestParam(value = "nif") String nif){
        ...
        mav.setViewName("EFichapdfPresupuestoPdf");        
        return mav;
    }
     @RequestMapping(value = "EFichaverCertificacionesPdf.htm",method=RequestMethod.GET)
       ...
       String ruta="";
        try{
            ...
            if(res!=0){
                ...
                map.addAttribute("menu",r);
                map.addAttribute("nif",prop.getCliente_nif().getNif());   
                ruta="EFichaverCertificacionesPdf";
            }else{
    ...
    @RequestMapping("EFichapdfCertificacionesPdf.htm")
    public ModelAndView pdfCertificacionesPdf(ModelAndView mav,@RequestParam(value = "nif") String nif){
        ...
        mav.addObject("menu",r);
        mav.addObject("nif",nif);
        mav.setViewName("EFichapdfCertificacionesPdf");        
        return mav;
    }
    ...
    @RequestMapping(value = "EFichaverContratoPdf.htm",method=RequestMethod.GET)
    public String verContratoPdf(@RequestParam(value = "idP") int idPr,ModelMap map) {
        ...
        return("EFichaverContratoPdf");
    }
    
    @RequestMapping("EpdfFichaContratoProyecto.htm")
    public ModelAndView pdf(ModelAndView mav){
        ...
        mav.setViewName("EpdfFichaContratoProyecto");        
        return mav;
    }
    
    @RequestMapping(value = "EverFichaPlanObraPdf.htm",method=RequestMethod.GET)
    ...
    @RequestMapping("EpdfFichaPlanObraPdf.htm")
    public ModelAndView pdfPlanObra(ModelAndView mav){
        ...
        mav.addObject("menu",r);
        mav.addObject("nif",prop.getCliente_nif().getNif());
        mav.setViewName("EpdfFichaPlanObraPdf");        
        return mav;
    }
