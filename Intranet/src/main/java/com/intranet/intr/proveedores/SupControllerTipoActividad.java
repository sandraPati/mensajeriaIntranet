...
@Controller
@RequestMapping("/sup/*")
public class SupControllerTipoActividad {
    @Autowired
    ...
    @RequestMapping("STipoActividad.htm")
    public ModelAndView TipoActividades(ModelAndView mav){
        ...
        mav.setViewName("STipoActividad");        
        return mav;
    }
    
    
     @RequestMapping(value = "addTipoActividad.htm",method=RequestMethod.GET)
    public String addTipoActividad_get(ModelMap map) {
        ...
        return "addTipoActividad";
    }
    
    @RequestMapping(value = "addTipoActividad.htm",method=RequestMethod.POST)
    public String addTipoActividad_post(@ModelAttribute("tipoActividad")tipo_actividades tipoActividad,BindingResult result) {
        ...
        try{
         ...
         return "redirect:STipoActividad.htm";
        
        
        
    }
    @RequestMapping(value = "updateTipoActividad.htm",method=RequestMethod.GET)
    public String updateTipoActividad_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "updateTipoActividad";
    }
    
    @RequestMapping(value = "updateTipoActividad.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value="deleteTipoActividad.htm",method=RequestMethod.GET)
