...
@Controller
@RequestMapping("/sup/*")
public class SupControllerProyectoGaleriaCertificaciones {
    @Autowired
    ...
    @RequestMapping(value = "Certificaciones_galeria.htm",method=RequestMethod.GET)
    public String Certificaciones_galeria_get(ModelMap map,@RequestParam(value = "idC") int id) {
        ...
        return "Certificaciones_galeria";
    }
   ...
   @RequestMapping(value = "Certificaciones_galeria.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "galeriaDelete.htm",method=RequestMethod.GET)
    public String EjdeleteVentanas(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:Certificaciones_galeria.htm?idC="+p.getId_proyecto_certificaciones().getId();
    }
    
    @RequestMapping(value = "ProyectoGaleria.htm",method=RequestMethod.GET)
    public String ProyectoGaleria_get(ModelMap map,@RequestParam(value = "nifC") String nifC2,@RequestParam(value = "id") int id) {
        ...
        map.addAttribute("fotogaleria",new proyecto_certificaciones_galeria());
         map.addAttribute("ltaFotos",ltaFotos);
        return "ProyectoGaleria";
    }
    
    
    
    @RequestMapping(value = "ProyectoGaleriaDelete.htm",method=RequestMethod.GET)
    public String ProyectoGaleriaDelete(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:ProyectoGaleria.htm?nifC="+nifC+"&id="+idP;
    }
    ...
    try{
        ...
        for(FileItem item : partes)
        {
            ...
            }else ruta="redirect:SLtaClientesProyecto.htm";
        }
        System.out.println("Archi subido correctamente");
    }
    catch(Exception ex)
