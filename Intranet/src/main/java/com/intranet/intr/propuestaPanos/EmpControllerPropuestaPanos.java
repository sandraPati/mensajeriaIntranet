...
@Controller
@RequestMapping("/emp/*")
public class EmpControllerPropuestaPanos {
    @Autowired
    ...
    @RequestMapping(value = "EmpjaddEstancia.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "EmpjaddEstancia.htm",method=RequestMethod.POST)
    public String addEstancia_post(@ModelAttribute("estancia")estancias estan,BindingResult result,Principal principal) {
        ...
        try{
         ...
         return "redirect:EmpjaddPano.htm?idE="+idE;
    }
    
    @RequestMapping(value = "EmpjaddPano.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "EmpjaddPano.htm",method=RequestMethod.POST)
    public String addPano_post(@ModelAttribute("pa")panos pan,BindingResult result) {
        String ruta="redirect:EmpjaddVentanas.htm";
        try{
            ...
            //e.setId(idE);
                    ...
                    if(pan.getFormapano()==1)pan.setLado3(0);
                    pan.setEstancia_id(est);
                    panosService.Insert(pan);
                    if(pan.getTipo_pano_id().getId()!=1)ruta="redirect:EmpMasPanos.htm?idE="+est.getId();
    ...
    @RequestMapping(value = "EmpjaddPano2.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "EmpjaddPano2.htm",method=RequestMethod.POST)
    public String addPano2_post(@ModelAttribute("pa")panos pan,BindingResult result) {
        String ruta="redirect:EmpjaddVentanas.htm";
        try{
            System.out.println("ventana:"+pan.getVentana());
    ...
    @RequestMapping(value = "EmpjaddVentanas.htm",method=RequestMethod.GET)
    public String addVentanas_get(ModelMap map) {
        ...
        return "EmpjaddVentanas";
    }
    
    @RequestMapping(value = "EmpjaddVentanas.htm",method=RequestMethod.POST)
    public String addVentanas_post(@ModelAttribute("pa")panos p,BindingResult result) {
        String ruta="redirect:EmpjaddPuertas.htm";
            ...
            if(p.getVentana().equals("SI")){
                ruta="redirect:EmpjaddVentanasF.htm";
            }
            
         return ruta;
    }
    
    @RequestMapping(value = "EmpjaddVentanasF.htm",method=RequestMethod.GET)
    public String addVentanasF_get(ModelMap map) {
        ...
        return "EmpjaddVentanasF";
    }
    
    @RequestMapping(value = "EmpjaddVentanasF.htm",method=RequestMethod.POST)
    public String addVentanasF_post(@ModelAttribute("vent")ventanas v,BindingResult result) {
        String ruta="redirect:EmpjaddVentanasF.htm";
        try{
            //vent=v;
            v.setIdpano(pano);
            ...
            if(pano.getNumventanas()==ltaventana.size()){
                ruta="redirect:EmpjaddPuertas.htm";
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "EmpjaddPuertas.htm",method=RequestMethod.GET)
    public String addPuertas_get(ModelMap map) {
        ...
        return "EmpjaddPuertas";
    }
    
    @RequestMapping(value = "EmpjaddPuertas.htm",method=RequestMethod.POST)
    public String addPuertas_post(@ModelAttribute("pa")panos p,BindingResult result) {
        String ruta="redirect:EmpjaddArmarios.htm";
        try{
            ...
            if(p.getPuertas().equals("SI")){
                ruta="redirect:EmpjaddPuertasF.htm";
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "EmpjaddPuertasF.htm",method=RequestMethod.GET)
    ...
    @RequestMapping("/jsonEjaddPuertasFEmp.htm")
    public @ResponseBody String jsonAddPresupSubCap(@RequestBody puertas p ){
        String ruta="/Intranet/emp/EmpjaddPuertasF.htm";
            
            p.setIdpano(pano);
            puertasService.Insert(p);
            ltapuerta=puertasService.findAll(pano.getId());
            if(pano.getNumpuertas()==ltapuerta.size()){
                ruta="/Intranet/emp/EmpjaddArmarios.htm";
            }
        return ruta; 
    }
    
    @RequestMapping(value = "EmpjaddArmarios.htm",method=RequestMethod.GET)
    public String addArmarios_get(ModelMap map) {
        ...
        return "EmpjaddArmarios";
    }
    
    @RequestMapping(value = "EmpjaddArmarios.htm",method=RequestMethod.POST)
    public String addArmarios_post(@ModelAttribute("pa")panos p,BindingResult result) {
        String ruta="redirect:EmpMasPanos.htm?idE="+pano.getEstancia_id().getId();
        try{
            ...
            if(p.getArmario().equals("SI")){
                ruta="redirect:EmpjaddArmariosF.htm";
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "EmpjaddArmariosF.htm",method=RequestMethod.GET)
    public String addArmarioF_get(ModelMap map) {
        ...
        return "EmpjaddArmariosF";
    }
    
    @RequestMapping(value = "EmpjaddArmariosF.htm",method=RequestMethod.POST)
    public String addArmario_post(@ModelAttribute("arm")armarios p,BindingResult result) {
        String ruta="redirect:EmpjaddArmariosF.htm";
        try{
            p.setIdpano(pano);
            armariosService.Insert(p);
            ltaarmario=armariosService.findAll(pano.getId());
            if(pano.getNumarmarios()==ltaarmario.size()){
                ruta="redirect:EmpMasPanos.htm?idE="+pano.getEstancia_id().getId();
            }
    ...
    @RequestMapping(value = "EmpMasPanos.htm",method=RequestMethod.GET)
    ...
    @RequestMapping(value = "EmpFinPropuesta.htm",method=RequestMethod.GET)
    public String FinPropuesta(ModelMap map) {
        ...
        return "redirect:EconsultarPropuesta.htm?idP="+est.getPropuesta_id().getId();
    }
    ...
    public panos updateMedidas(panos p){
     ...
     @RequestMapping(value = "EmpVolcar.htm",method=RequestMethod.GET)
    public String Volcar_get(ModelMap map) {
     ...
     @RequestMapping(value = "EmpjaddPanoVolcar.htm",method=RequestMethod.GET)
    public String addPanoVolcar_get(ModelMap map) {
        ...
        map.addAttribute("pa",pano);
        map.addAttribute("ltaTipoPano",ltaTipoPano);
        return "EmpjaddPanoVolcar";
    }
    
    @RequestMapping(value = "EmpjaddPanoVolcar.htm",method=RequestMethod.POST)
    public String addPanoVolcar_post(@ModelAttribute("pa")panos pan,BindingResult result) {
        ...
        try{
         ...
         return "redirect:EmpVolcar.htm";
    }
    
    @RequestMapping(value = "EmpjaddVentanasVolcar.htm",method=RequestMethod.GET)
    public String addVentanasVolcar_get(ModelMap map) {
        ...
        return "EmpjaddVentanasVolcar";
    }
    
    @RequestMapping(value = "EmpjaddVentanasVolcar.htm",method=RequestMethod.POST)
    public String addVentanasVolcar_post(@ModelAttribute("pa")panos p,BindingResult result) {
        ...
        try{
            ...
            pano.setNumventanas(p.getNumventanas());
                ...
                ruta="redirect:EmpjaddVentanasFVolcarAdd.htm";
    ...
    @RequestMapping(value = "EmpjaddVentanasFVolcar.htm",method=RequestMethod.GET)
    public String addVentanasFVolcar_get(ModelMap map) {
        ...
        return "EmpjaddVentanasFVolcar";
    }
    
    @RequestMapping(value = "EmpjaddVentanasFVolcar.htm",method=RequestMethod.POST)
   ...
   @RequestMapping(value = "EmpjaddVentanasFVolcarAdd.htm",method=RequestMethod.GET)
    public String addVentanasFVolcarAdd_get(ModelMap map) {
        ...
        map.addAttribute("pa",pano);
        map.addAttribute("ltaventana",ltaventana);
        return "EmpjaddVentanasFVolcarAdd";
    }
    
    @RequestMapping(value = "EmpjaddVentanasFVolcarAdd.htm",method=RequestMethod.POST)
    public String addVentanasFVolcarAdd_post(@ModelAttribute("vent")ventanas v,BindingResult result) {
        String ruta="redirect:EmpjaddVentanasFVolcarAdd.htm";
        try{
            System.out.println("Pano: "+pano.getNumventanas()+"ventana: "+v.getNum()+"largo:"+v.getLargo()+"alto:"+v.getAlto()+"sup:"+v.getSuperficie());
            //vent=v;
            ltaventana.add(v);
    ...
    @RequestMapping(value = "EmpjaddPuertasVolcar.htm",method=RequestMethod.GET)
    public String addPuertasVolcar_get(ModelMap map) {
        ...
        return "EmpjaddPuertasVolcar";
    }
    
    @RequestMapping(value = "EmpjaddPuertasVolcar.htm",method=RequestMethod.POST)
    public String addPuertasVolcar_post(@ModelAttribute("pa")panos p,BindingResult result) {
        String ruta="redirect:EmpjaddArmariosVolcar.htm";
        try{
            pano.setPuertas(p.getPuertas());
            pano.setNumpuertas(p.getNumpuertas());
            if(p.getPuertas().equals("SI")){
                ruta="redirect:EmpjaddPuertasFVolcar.htm";
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "EmpjaddPuertasFVolcar.htm",method=RequestMethod.GET)
    public String addPuertasFVolcar_get(ModelMap map) {
        ...
        map.addAttribute("pa",pano);
        map.addAttribute("ltapuerta",ltapuerta);
        return "EmpjaddPuertasFVolcar";
    }
    
    @RequestMapping(value = "EmpjaddPuertasFVolcar.htm",method=RequestMethod.POST)
    public String addPuertasVolcar_post(@ModelAttribute("pue")puertas p,BindingResult result) {
        String ruta="redirect:EmpjaddPuertasFVolcar.htm";
        try{
            ...
            if(pano.getNumpuertas()==ltapuerta.size()){
                ruta="redirect:EmpjaddArmariosVolcar.htm";
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "EmpjaddArmariosVolcar.htm",method=RequestMethod.GET)
    public String addArmariosVolcar_get(ModelMap map) {
        ...
        return "EmpjaddArmariosVolcar";
    }
    
    @RequestMapping(value = "EmpjaddArmariosVolcar.htm",method=RequestMethod.POST)
    public String addArmariosVolcar_post(@ModelAttribute("pa")panos p,BindingResult result) {
        String ruta="redirect:EmpMasPanos.htm";
        try{
            pano.setArmario(p.getArmario());
            pano.setNumarmarios(p.getNumarmarios());
            System.out.println("numArmarios:"+pano.getNumarmarios());
            if(p.getArmario().equals("SI")){
                ruta="redirect:EmpjaddArmariosFVolcar.htm";
            }
        }catch(Exception ex){            
        }
    ...
    @RequestMapping(value = "EmpjaddArmariosFVolcar.htm",method=RequestMethod.GET)
    public String addArmarioFVolcar_get(ModelMap map) {
        ...
        map.addAttribute("pa",pano);
        map.addAttribute("ltaarmario",ltaarmario);
        return "EmpjaddArmariosFVolcar";
    }
    
    @RequestMapping(value = "EmpjaddArmariosFVolcar.htm",method=RequestMethod.POST)
    public String addArmarioVolcar_post(@ModelAttribute("arm")armarios p,BindingResult result) {
        String ruta="redirect:EmpjaddArmariosFVolcar.htm";
        try{
