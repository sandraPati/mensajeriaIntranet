...
@Controller
@RequestMapping("/emp/*")
public class EmpControllerPropuestaPanosUpdate {
    @Autowired
    ...
    @RequestMapping(value = "EmpjupdatePano.htm",method=RequestMethod.GET)
    public String addPano_get(ModelMap map,@RequestParam(value = "idPano") int id) {
        ...
        return "EmpjupdatePano";
    }
    
    @RequestMapping(value = "EmpjupdatePano.htm",method=RequestMethod.POST)
    public String addPano_post(@ModelAttribute("pa")panos pan,BindingResult result) {
        String ruta="redirect:EmpjupdateVentanas.htm?idPano="+pano.getId();
                   ...
                   if(pan.getTipo_pano_id().getId()==2)pan.setNombrepano("Suelo");
                    ...
                    if(pan.getTipo_pano_id().getId()!=1){
                        ...
                        ruta="redirect:EverEstancias.htm?idE="+pan.getEstancia_id().getId();
                    }else{ 
                        pan.setTotal(pan.getSuperficie());
                        panosService.Update(pan);
                    }
    ...
    @RequestMapping(value = "EmpjupdateVentanas.htm",method=RequestMethod.GET)
    public String EjupdateVentanas_get(ModelMap map,@RequestParam(value = "idPano") int id) {
        ...
        return "EmpjupdateVentanas";
    }
    @RequestMapping(value = "EmpjupdateVentanasFadd.htm",method=RequestMethod.GET)
    public String EjupdateaddVentanas_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "EmpjupdateVentanasFadd";
    }
    @RequestMapping(value = "EmpjupdateVentanasFadd.htm",method=RequestMethod.POST)
    public String EjupdateassVentanasF_post(@ModelAttribute("vent")ventanas v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:EmpjupdateVentanas.htm?idPano="+v.getIdpano().getId();
    }
    @RequestMapping(value = "EmpjupdateVentanasF.htm",method=RequestMethod.GET)
    public String EjupdateVentanasF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "EmpjupdateVentanasF";
    }
    
    @RequestMapping(value = "EmpjupdateVentanasF.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "EmpjdeleteVentanas.htm",method=RequestMethod.GET)
    public String EjdeleteVentanas(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:EmpjupdateVentanas.htm?idPano="+ventana.getIdpano().getId()+"";
    }
    
    //puertas
    
    @RequestMapping(value = "EmpjupdatePuertas.htm",method=RequestMethod.GET)
    public String EjupdatePuertas_get(ModelMap map,@RequestParam(value = "idPano") int id) {
        ...
        return "EmpjupdatePuertas";
    }
    @RequestMapping(value = "EmpjupdatePuertasFadd.htm",method=RequestMethod.GET)
    public String EjupdateaddPuertas_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "EmpjupdatePuertasFadd";
    }
    @RequestMapping(value = "EmpjupdatePuertasFadd.htm",method=RequestMethod.POST)
    public String EjupdateassPuertasF_post(@ModelAttribute("pu")puertas v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:EmpjupdatePuertas.htm?idPano="+v.getIdpano().getId();
    }
    @RequestMapping(value = "EmpjupdatePuertasF.htm",method=RequestMethod.GET)
    public String EjupdatePuertasF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "EmpjupdatePuertasF";
    }
    
    @RequestMapping(value = "EmpjupdatePuertasF.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "EmpjdeletePuertas.htm",method=RequestMethod.GET)
    public String EjdeletePuertas(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:EmpjupdatePuertas.htm?idPano="+p.getIdpano().getId()+"";
    }
    ...
    @RequestMapping(value = "EmpjupdateArmario.htm",method=RequestMethod.GET)
    public String EjupdateArmario_get(ModelMap map,@RequestParam(value = "idPano") int id) {
        ...
        return "EmpjupdateArmario";
    }
    @RequestMapping(value = "EmpjupdateArmarioFadd.htm",method=RequestMethod.GET)
    public String EjupdateaddArmario_get(ModelMap map,@RequestParam(value = "idP") int id) {
        ...
        return "EmpjupdateArmarioFadd";
    }
    @RequestMapping(value = "EmpjupdateArmarioFadd.htm",method=RequestMethod.POST)
    public String EjupdateassArmarioF_post(@ModelAttribute("arm")armarios v,BindingResult result) {
        ...
        try{
         ...
         return "redirect:EmpjupdateArmario.htm?idPano="+v.getIdpano().getId();
    }
    @RequestMapping(value = "EmpjupdateArmarioF.htm",method=RequestMethod.GET)
    public String EjupdateArmarioF_get(ModelMap map,@RequestParam(value = "id") int id) {
        ...
        return "EmpjupdateArmarioF";
    }
    
    @RequestMapping(value = "EmpjupdateArmarioF.htm",method=RequestMethod.POST)
    ...
    @RequestMapping(value = "EmpjdeleteArmario.htm",method=RequestMethod.GET)
    public String EjdeleteArmario(@RequestParam(value = "id") int id,ModelMap map) {
        ...
        return "redirect:EmpjupdateArmario.htm?idPano="+p.getIdpano().getId()+"";
    }
    
    
    
    
    @RequestMapping(value = "EmpjupdateFinish.htm",method=RequestMethod.GET)
    public String EjupdateFinish(ModelMap map,@RequestParam(value = "idPano") int id) {
        ...
        return "redirect:EverEstancias.htm?idE="+est.getId();
    }
