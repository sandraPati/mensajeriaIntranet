    ...
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            ...
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/EPverLtaPresupuestos.htm?id=${lta.id_proveedor}" data-rel="tooltip">
        ...
        <div class="row" >
              <div class="col-xs-12">                             
                    <div class="form-group">
                            <div class="col-sm-12">
                                 <c:if test="${lta.estado==1}">
                                     <form:form id="form1" action="" method="POST" commandName="lta" class="form-horizontal" role="form">
                                             <form:hidden id="id" path="id" value="${lta.id}"/> 
                                     <p class="alert alert-info">
                                          ...
                                          <a href="/Intranet/emp/EPBuscarCliente.htm?idP=${idP}"id="btn_aprobarRA2" class="btn btn-white btn-success  btn-round">
                                ...
                                <c:if test="${lta.estado==2}">
                                    <form:form id="form2" action="" method="POST" commandName="lta" class="form-horizontal" role="form">
                                             <form:hidden id="id" path="id" value="${lta.id}"/> 
