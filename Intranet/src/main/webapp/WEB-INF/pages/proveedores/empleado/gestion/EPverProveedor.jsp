                            ...
                            <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                 <label class="col-sm-12 control-label no-padding-right" >${proveedor.persona_contacto}</label>
                                                <br/>
                                            </div>
                                    </div> 
                    ...
                    <tbody>
                        <c:forEach items="${listaCalificaciones}" var="item">
                            <tr>
                                    ...
                                    <td>
                                        <div class="calidadtrabajo" data-rating="${item.calidadtrabajo}"></div>
                                    </td>
                                    <td>
                                        <div class="limpiezaorden" data-rating="${item.limpiezaorden}"></div>
                                    </td>
                                    <td>
                                        <div class="plazos" data-rating="${item.plazos}"></div>
                                    </td>
                                    <td>
                                        <div class="cumplimiento" data-rating="${item.cumplimiento}"></div>
                                    </td>
                            </tr>
                        </c:forEach> 
