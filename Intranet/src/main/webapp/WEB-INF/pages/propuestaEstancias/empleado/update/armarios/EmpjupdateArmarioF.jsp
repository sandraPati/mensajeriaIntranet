...
<div class="row">
    ...
    <div class="col-xs-12">
                  ...
                  <form:form id="form1" action="" method="POST" commandName="arm" class="form-horizontal" role="form">
                   <form:hidden id="id" path="id" class="col-xs-10 col-sm-4" value="${arm.id}"/>
                   <form:hidden id="idpano" path="idpano.id" class="col-xs-10 col-sm-4" value="${arm.idpano.id}"/>
                          <div class="form-group" >
                            <label class="col-sm-1 control-label no-padding-right" for="form-field-1">Ventana N° ${arm.num}</label>
                            ...
                            <div class="col-sm-1">
                                <form:input type="text" id="fondo" path="fondo" class="col-xs-10 col-sm-12" />
                            </div>
