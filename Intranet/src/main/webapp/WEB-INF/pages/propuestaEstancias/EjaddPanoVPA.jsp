...
<div class="col-xs-12">
    ...
    <div class="form-group" id="Otro">
      <a class=" btn btn-white btn-warning" href="/Intranet/sup/EjaddVentanas.htm" data-rel="tooltip">
        <i class="ace-icon fa fa-reply icon-only"></i>Ventanas
      </a>
        <a class=" btn btn-white btn-warning" href="/Intranet/sup/EjaddVentanas.htm" data-rel="tooltip">
        <i class="ace-icon fa fa-reply icon-only"></i>Puertas
      </a>
        <a class=" btn btn-white btn-warning" href="/Intranet/sup/EjaddVentanas.htm" data-rel="tooltip">
        <i class="ace-icon fa fa-reply icon-only"></i>Armarios
      </a>
    </div>
