    ...
    <div class="col-xs-12">
                  ...
                  <div id="venN">
                    <c:set value="${pa.numventanas}" var="n" scope="page" />
                      <c:forEach items="${ltaventana}" var="itemv">
                          <c:set value="0" var="nVen" scope="page" />
                            <c:forEach items="${ltaventana2}" var="item">
                        ...
                        <form:form id="form${i}"action="" method="POST" commandName="vent">
                          <div class="form-group" >
                            ...
                            <form:hidden id="numV" path="num"  class="col-xs-10 col-sm-4" value="${itemv.num}"/>
                            <label class="col-sm-1 control-label no-padding-right" for="form-field-1">LARGO</label>
                            <div class="col-sm-1">
                                <form:input type="text" id="largoventana${i}" path="largo" class="col-xs-10 col-sm-12" value="${itemv.largo}"/>
                            </div>
                            
                            <label class="col-sm-1 control-label no-padding-right" for="form-field-1">ALTO</label>
                            <div class="col-sm-1">
                                <form:input type="text" id="altoventana${i}" path="alto" class="col-xs-10 col-sm-12" value="${itemv.alto}"/>
                            </div>
                            
                            <label class="col-sm-1 control-label no-padding-right" for="form-field-1">SUPERFICIE</label>
                            <div class="col-sm-1">
                                <form:input type="text" id="superficieventana${i}" path="superficie" class="col-xs-10 col-sm-12" value="${itemv.superficie}" readonly="true"/>
                            </div>
                             <div class="col-sm-5">
