    ...
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            ...
            <a class=" btn btn-white btn-warning" href="/Intranet/sup/consultarPropuesta.htm?idP=${estancia.propuesta_id.id}" data-rel="tooltip">
...
<div class="page-header">
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/sup/EjaddPano2.htm?idE=${estancia.id}" data-rel="tooltip">
                Agregar
            </a>
                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="orange tooltip-warning" data-rel="tooltip" href="/Intranet/sup/volcarPano.htm?idPano=${item.id}" title="Volcar Paño">
                                                            <i class="ace-icon glyphicon glyphicon-repeat bigger-130"></i>
                                                    </a> 
                                                <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/sup/verPanos.htm?idPano=${item.id}" title="Consultar Paño">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                    </a>    
                                                <a class="green tooltip-success" data-rel="tooltip" href="/Intranet/sup/EjupdatePano.htm?idPano=${item.id}" title="Actualizar">
                                                   <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>            
                                                <a class="red tooltip-error" data-rel="tooltip" href="/Intranet/sup/deletePano.htm?idE=${estancia.id}&idP=${item.id}" title="Eliminar">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    <li>
                                                                            <a href="/Intranet/sup/volcarPano.htm?idPano=${item.id}" class="tooltip-warning" data-rel="tooltip" title="Volcar_Paño">
                                                                                    <span class="orange">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/verPanos.htm?idPano=${item.id}" class="tooltip-info" data-rel="tooltip" title="Consultar_Paño">
                                                                                    <span class="blue">
                                                                     ...
                                                                     <li>
                                                                            <a href="/Intranet/sup/EjupdatePano.htm?idPano=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                     ...
                                                                     <li>
                                                                            <a href="/Intranet/sup/deletePano.htm?idE=${estancia.id}&idP=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
