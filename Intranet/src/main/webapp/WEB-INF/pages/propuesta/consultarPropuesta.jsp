    ...
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/sup/updatePropuesta.htm?idP=${prop.id}" data-rel="tooltip">
                Actualizar
            </a>
...
<div class="page-header">
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/sup/EjaddEstancia.htm?idP=${prop.id}" data-rel="tooltip">
                Agregar
            </a>
                    ...
                    <tbody>
                        <c:forEach items="${ltaEstancias}" var="item">
                            <tr>
                                    ...
                                    <td>
                                            <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/sup/verEstancias.htm?idE=${item.id}" title="Consultar_Estancia">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                    </a> 
                                            <a class="red tooltip-error" data-rel="tooltip" href="/Intranet/sup/deleteEstancia.htm?idE=${item.id}&idP=${prop.id}" title="Eliminar_Estancia">
