...
<div class="row">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/ENuevaPropuestaExpresVerPanosC.htm?idE=${pex.idestancia}" data-rel="tooltip">
                <i class="ace-icon fa fa-reply icon-only"></i>

            </a> 
              <a class="btn btn-success  btn-md "  href="/Intranet/emp/ENuevaPropuestaExpresPresupuestoC.htm?idP=${idP}">
