    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form:form id="form1" class="form-horizontal" role="form" action="" method="POST" commandName="estancia">
               ...
               <form:hidden id="tipo_estancia_id" path="tipo_estancia_id.id" value="5"/>
                <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">N°</label>

                        <div class="col-sm-9">
                            <form:input type="text" id="numero" path="numero" value="1"class="col-xs-10 col-sm-1" readonly="true"/>
