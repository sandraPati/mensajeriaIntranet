...
<div class="col-xs-12">
    <div class="tabbable">
        ...
        <div class="col-lg-12 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/ENuevaPropuestaExpresPresupuestoC.htm?idP=${p.id}" data-rel="tooltip">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="SubCapCheck">
                                            ...
                                            <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/ENuevaPropuestaExpresPresupuesto3C.htm?idP=${idP}&idPre=${presup}&idSC=${item.subcapitulo.id}" title="Registro_Medidas">
                                     ...
                                     <td>
                                        <div id="SubCapCheck">
                                                ...
                                                <c:if test="${item.tipoCantidad=='m2' || item.tipoCantidad=='ml'}">
                                                    ...
                                                    <a class="green tooltip-success" data-rel="tooltip"href="/Intranet/emp/ENuevaPropuestaExpresPresupuestoasignarLtaGuardadaC.htm?idP=${idP}&idPre=${presup}&idSC=${item.subcapitulo.id}" title="Asignar_Panos_Guardados">
