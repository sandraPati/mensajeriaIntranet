            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                            ...
                            <div id="home4" class="tab-pane in active">
                                ...
                                <a class=" btn btn-white btn-success" href="/Intranet/emp/ENuevaPropuestaExpresPanosC.htm?idE=${estancia.id}" data-rel="tooltip">
                                    NUEVO Paño

                                </a>
                                     <c:if test="${not empty ltaPanos}">    
                                <a class="btn btn-success  btn-md "  href="/Intranet/emp/ENuevaPropuestaPExpresC.htm?idE=${estancia.id}">
                                   Paso 3 Presupuesto Expres<i class="ace-icon fa fa-arrow-right icon-on-right"></i>
                                </a>
                                   </c:if>
                                </div>
                                    <br/><br/><br/>
                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="orange tooltip-warning" data-rel="tooltip" href="/Intranet/emp/ENuevaPropuestaExpresvolcarPanoC.htm?idPano=${item.id}" title="Volcar Paño">
                                                            <i class="ace-icon glyphicon glyphicon-repeat bigger-130"></i>
                                                    </a> 
                                                <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/ENuevaPropuestaExpresVerPC.htm?idPano=${item.id}" title="Consultar Paño">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                    </a>    
                                                <a class="green tooltip-success" data-rel="tooltip" href="/Intranet/emp/ENuevaPropuestaExpresUpdatePanoC.htm?idP=${item.id}" title="Actualizar">
                                                   <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>            
                                                <a class="red tooltip-error" data-rel="tooltip" href="/Intranet/emp/ENuevaPropuestaExpresDeletePanoC.htm?idE=${estancia.id}&idP=${item.id}" title="Eliminar">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    <li>
                                                                            <a href="/Intranet/emp/ENuevaPropuestaExpresvolcarPanoC.htm?idPano=${item.id}" class="tooltip-warning" data-rel="tooltip" title="Volcar_Paño">
                                                                                    <span class="orange">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/ENuevaPropuestaExpresVerPC.htm?idPano=${item.id}" class="tooltip-info" data-rel="tooltip" title="Consultar_Paño">
                                                                                    <span class="blue">
                                                                     ...
                                                                     <li>
                                                                            <a href="/Intranet/emp/ENuevaPropuestaExpresUpdatePanoC.htm?idP=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                     ...
                                                                     <li>
                                                                            <a href="/Intranet/emp/ENuevaPropuestaExpresDeletePanoC.htm?idE=${estancia.id}&idP=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
