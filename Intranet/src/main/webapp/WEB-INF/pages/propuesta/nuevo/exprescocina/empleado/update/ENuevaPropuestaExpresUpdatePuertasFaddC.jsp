                ...
                <div class="tab-content">
                   ...
                   <form:hidden id="idpano" path="idpano.id" class="col-xs-10 col-sm-4" value="${pu.idpano.id}"/>
                          <div class="form-group" >
                            <label class="col-sm-1 control-label no-padding-right" for="form-field-1">Puerta N°:</label>
                            <div class="col-sm-1">
                            ...
                            <div class="col-sm-1">
                             ...
                             <button type="submit" class="btn btn-primary btn-sm col-xs-12 col-sm-12 col-md-12 col-lg-8">Guardar</button>
                             </div> 
                        </div><br/><br/>
                        </form:form>
                </div>
