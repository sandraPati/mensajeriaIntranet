...
<div class="row">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/ENuevaPropuestaExpresVerPanos.htm?idE=${pex.idestancia}" data-rel="tooltip">
                <i class="ace-icon fa fa-reply icon-only"></i>

            </a> 
              <a class="btn btn-success  btn-md "  href="/Intranet/emp/ENuevaPropuestaExpresPresupuesto.htm?idP=${idP}">
            ...
            <form id="form1" class="form-horizontal" role="form" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                               ...
                               <div class="checkbox">
                                        <label>
                                            <c:if test="${pex.ducha==0}">
                                            <input type="checkbox" id="ducha" name="form-field-checkbox"  value="${pex.ducha}" class="ace" />
                                            </c:if>
                                            <c:if test="${pex.ducha==1}">
                                                <input type="checkbox" id="ducha" name="form-field-checkbox"  value="${pex.ducha}" class="ace" checked="true" />
                                            </c:if>
                                                <span class="lbl"> Ducha (PFD)</span>
                                        </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="radioducha" hidden="true">    
                            <div class="col-sm-4"></div>
                            <div class="col-sm-8">
                                <c:if test="${pex.duchatipo==1}">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" id="duchatipo1"   name="duchatipo" value="1" class="ace" checked="true"/>

                                                <span class="lbl">Bañera por Ducha (PFDD)</span>
                                            </label> 
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" id="duchatipo2"  name="duchatipo" value="2" class="ace"/>

                                                <span class="lbl">Bañera por bañera (PFDB)</span>
                                            </label>

                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" id="duchatipo3" name="duchatipo" value="3" class="ace"/>

                                                <span class="lbl">Bañera por ducha de obra (PFDO)</span>
                                            </label>

                                        </div>
                                        </c:if>
                                   <c:if test="${pex.duchatipo==2}">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" id="duchatipo1"   name="duchatipo" value="1" class="ace" />
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" id="duchatipo2"  name="duchatipo" value="2" class="ace" checked="true"/>
                                ...
                                <c:if test="${pex.duchatipo==3}">
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" id="duchatipo3" name="duchatipo" value="3" class="ace" checked="true"/>
                        ...
                        <div class="form-group">     
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                        <label>
                                            <c:if test="${pex.inodoro==0}">
                                                <input type="checkbox" id="inodoro"  name="form-field-checkbox" value="${pex.inodoro}" class="ace" />
                                            </c:if>
                                                <c:if test="${pex.inodoro==1}">
                                                    <input type="checkbox" id="inodoro"  name="form-field-checkbox" value="${pex.inodoro}" class="ace" checked="true" />
                                            </c:if>
                                                <span class="lbl"> Inodoro (PFI)</span>
                                        </label>
                                </div>

                                <div class="checkbox">
                                        <label>
                                             <c:if test="${pex.lavabo==0}">
                                                <input type="checkbox" id="lavabo"  name="form-field-checkbox" value="${pex.lavabo}" class="ace"/>
                                             </c:if>
                                                <c:if test="${pex.lavabo==1}">
                                                    <input type="checkbox" id="lavabo"  name="form-field-checkbox" value="${pex.lavabo}" class="ace" checked="true"/>
                                             </c:if>
                                                <span class="lbl"> Lavabo (PFL)</span>
                                        </label>
                                </div>
                                <div class="checkbox">
                                        <label>
                                            <c:if test="${pex.bide==0}">
                                                <input type="checkbox" id="bide"  name="form-field-checkbox" value="${pex.bide}" class="ace"/>
                                            </c:if>
                                            <c:if test="${pex.bide==1}">
                                                <input type="checkbox" id="bide"  name="form-field-checkbox" value="${pex.bide}" class="ace" checked="true"/>
                                            </c:if>
                                                <span class="lbl"> Bide (PFB)</span>
                                        </label>
                                </div>
