...
<div class="col-xs-12">
    <div class="tabbable">
        ...
        <div class="col-lg-12 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/ENuevaPropuestaPExpres.htm?idE=${idE}" data-rel="tooltip">
                <i class="ace-icon fa fa-reply icon-only"></i>

            </a> 
                <a class="btn btn-success  btn-md "  href="/Intranet/emp/ENuevaPropuestaExpresVerPresupuestoPdf.htm?idP=${p.id}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="SubCapCheck">
                                            ...
                                            <a class="blue tooltip-info" data-rel="tooltip"href="/Intranet/emp/ENuevaPropuestaExpresPresupuesto2.htm?idP=${p.id}&idC=${item.cap.id}"title="Ver_SubCapitulos">
