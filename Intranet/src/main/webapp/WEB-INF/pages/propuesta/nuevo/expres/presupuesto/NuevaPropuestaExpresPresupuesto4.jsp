...
<div class="col-xs-12">
        ...
        <div class="col-lg-12 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/sup/NuevaPropuestaExpresPresupuesto2.htm?idP=${p.id}&idC=${idC}" data-rel="tooltip">
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <div id="SubCapCheck">
                                            ...
                                            <a class="blue tooltip-info" data-rel="tooltip"href="/Intranet/sup/NuevaPropuestaExpresPresupuesto5.htm?idE=${item.id}&idP=${p.id}&idPre=${idPre}&idSC=${idSC}&idPresup=${pres1}"title="Asignar_Panos">
