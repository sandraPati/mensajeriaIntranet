            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                            <div id="home4" class="tab-pane in active">
                                ...
                                <br/>
                                <a class=" btn btn-white btn-success" href="/Intranet/sup/NuevaPropuestaPanos.htm?idE=${est}" data-rel="tooltip">
                                    NUEVO Paño

                              </a>
                              <a class=" btn btn-white btn-success" href="/Intranet/sup/NuevaPropuestaFinPropuesta.htm?idE=${est}" data-rel="tooltip">
                                  Guardar y Registrar otra estancia
                              </a> 
                              <a class=" btn btn-white btn-success" href="/Intranet/sup/NuevaPropuestaFinPropuesta2.htm?idE=${est}" data-rel="tooltip">
                                  Ver Estancias
                              </a>     
                </div>
