            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                            <div id="home4" class="tab-pane in active">
                                ...
                                <br/>
                                <a class=" btn btn-white btn-success" href="/Intranet/emp/ENuevaPropuestaExpresPanosC.htm?idE=${est}" data-rel="tooltip">
                                    NUEVO Paño

                              </a>
                              
                              <a class=" btn btn-white btn-success" href="/Intranet/emp/ENuevaPropuestaExpresFinPropuesta2C.htm?idE=${est}" data-rel="tooltip">
                                  Ver Paños
                              </a>     
                </div>
