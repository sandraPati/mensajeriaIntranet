                ...
                <div class="tab-content">
                    <div id="home4" class="tab-pane in active">
                       <div class="col-lg-12 align-right">
                            <a class=" btn btn-white btn-warning" href="/Intranet/sup/NuevaPropuestaExpresPresupuestoC.htm?idP=${idP}" data-rel="tooltip">
                                <i class="ace-icon fa fa-reply icon-only"></i>

                            </a> 
                                <a class="btn btn-success  btn-md "  href="/Intranet/sup/NuevaPropuestaExpresenviarPresupuestoC.htm?idP=${idP}">
                        ...
                        <div >
                            <div>
                                  <iframe width="1060" height="900" src="/Intranet/sup/pdfPresupuesto.htm?idP=${idP}" scrolling="no" frameborder="no" ></iframe>
                            </div>
                        </div>
                       <br/><br/><br/> 
                    </div>
