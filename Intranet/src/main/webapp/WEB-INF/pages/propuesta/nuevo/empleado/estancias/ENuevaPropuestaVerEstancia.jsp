            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                            <div id="home4" class="tab-pane in active">
                               ...
                               <a class=" btn btn-error btn-md" href="/Intranet/emp/ENuevaPropuestaEstancias.htm?idP=${prop.id}" data-rel="tooltip">
                                    Registrar estancia

                                </a>
                                   
                                <c:if test="${not empty ltaEstancias}">    
                                <a class="btn btn-success  btn-md "  href="/Intranet/emp/ENuevaPropuestaPresupuesto.htm?idP=${prop.id}">
                                        ...
                                        <tbody>
                                            <c:forEach items="${ltaEstancias}" var="item">
                                                <tr>
                                                        ...
                                                        <td>
                                                                <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/ENuevaPropuestaVerPanos.htm?idE=${item.id}" title="Consultar_Estancia">
                                                                                <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                                        </a> 
                                                                <a class="red tooltip-error" data-rel="tooltip" href="/Intranet/emp/ENuevaPropuestaDeleteEstancia.htm?idE=${item.id}&idP=${prop.id}" title="Eliminar_Estancia">
