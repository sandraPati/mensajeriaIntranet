    ...
    <div class="row">
        ...
        <div class="table-responsive">
                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="green tooltip-success" data-rel="tooltip" href="/Intranet/emp/ENuevaPropuestaUpdatePuertasF.htm?id=${item.id}" title="Actualizar">
                                                   <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>            
                                                <a class="red" href="/Intranet/emp/ENuevaPropuestaDeletePuertas.htm?id=${item.id}" title="Eliminar">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                     ...
                                                                     <li>
                                                                            <a href="/Intranet/emp/ENuevaPropuestaUpdatePuertasF.htm?id=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                     ...
                                                                     <li>
                                                                            <a href="/Intranet/emp/ENuevaPropuestaDeletePuertas.htm?id=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
            ...
            <div class="col-lg-12 align-right">
                               <a class=" btn btn-error btn-md" href="/Intranet/emp/ENuevaPropuestaUpdatePuertasFadd.htm?idP=${idPano}" data-rel="tooltip">
                                    Agregar PUERTA

                                </a>
                                    
                                <a class="btn btn-success  btn-md "  href="/Intranet/emp/ENuevaPropuestaUpdateArmario.htm?idP=${idPano}">
