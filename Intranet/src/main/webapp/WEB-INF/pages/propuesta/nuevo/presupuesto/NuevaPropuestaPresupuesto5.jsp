...
<div class="col-xs-12">
        ...
        <div class="col-lg-12 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/sup/NuevaPropuestaPresupuesto4.htm?idP=${p.id}&idPre=${idPre}&idSC=${idSC}" data-rel="tooltip">
        ...
        <div class="table-responsive">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <div id="SubCapCheck">
                                            ...
                                            <a class="blue tooltip-info" data-rel="tooltip"href="/Intranet/sup/NuevaPropuestaPresupuesto6.htm?idE=${idE}&idP=${p.id}&idPre=${idPre}&idSC=${idSC}&idPresup=${idPresup}&idPsp=${idpresup_sup}&idPano=${item.id}"title="Asignar_Ventanas">
            ...
            <div class="col-lg-12 align-right">
                                ...
                                <a class="btn btn-success  "  href="/Intranet/sup/NuevaPropuestaPresupuestoG.htm?idP=${p.id}&idPre=${idPre}&idSC=${idSC}&idPresup=${idPresup}">
