...
<div class="page-header">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-warning" href="/Intranet/sup/updatePresupuesto2.htm?idPres=${prec.id}&idP=${prec.propuesta_id}" data-rel="tooltip">
          ...
          <form:form id="form1" class="form-horizontal" role="form" action="" method="POST" commandName="prec">
              ...
              <form:hidden id="propuesta_id" path="propuesta_id" value="${prec.propuesta_id}"/>
                ...
                <div class="form-group" id="Otro">
                        ...
                        <div class="col-sm-9">
                            <form:input type="text" id="cantidad" path="cantidad" value="${prec.cantidad}" class="col-xs-10 col-sm-4" required="true"/>
                        </div>
                </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-9">
                               <button type="submit" class="btn btn-success col-xs-12 col-sm-4 col-md-3 col-lg-3">Finish</button>
                        </div>
                </div>
