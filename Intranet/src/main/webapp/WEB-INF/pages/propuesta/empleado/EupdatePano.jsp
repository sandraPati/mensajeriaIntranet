...
<div class="page-header">
    <div class="row">
        <div class="col-lg-8">
        <h1>
            Actualizar Paño para la Estancia:
            <small>
...
<div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
          <form:form id="form1" class="form-horizontal" role="form" action="" method="POST" commandName="pa">
              <form:hidden id="id" path="id" value="${pa.id}"/>
                ...
                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                ...
                                                <div class="radio">
                                                        <label>
                                                            <form:radiobutton id="ventana2" path="ventana" value="NO" class="ace" />
                ...
                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                ...
                                                <div class="radio">
                                                        <label>
                                                            <form:radiobutton id="puertas2" path="puertas" value="NO" class="ace" />
                ...
                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                ...
                                                <div class="radio">
                                                        <label>
                                                            <form:radiobutton id="armario2" path="armario" value="NO" class="ace" />
...
<script type="text/javascript">
	$(document).ready(function(){
            ...
            if($("#puertas1").is(":checked")){
                $("#Numpuertas").show();
            }else if($("#puertas2").is(":checked")){
                $("#Numpuertas").hide();
            }
            if($("#armario1").is(":checked")){
                $("#Numarmarios").show();
            }else if($("#armario2").is(":checked")){
                $("#Numarmarios").hide();
            }
          //ventanas
