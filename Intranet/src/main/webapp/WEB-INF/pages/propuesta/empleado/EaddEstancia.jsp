    ...
    <div class="row">
        ...
        <small>
         ...
         <div class="col-lg-4 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/EconsultarPropuesta.htm?idP=${prop.id}" data-rel="tooltip">
...
<script type="text/javascript">
	$(document).ready(function(){
			...
			jQuery(function($) {
                            $('#tipo_estancia_id').on('change',function(e) {                            
                                if($('#tipo_estancia_id').val()=='6'){
                                   $('#Otro').show();
