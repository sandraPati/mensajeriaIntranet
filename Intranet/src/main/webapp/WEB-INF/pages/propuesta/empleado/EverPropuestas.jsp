    ...
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            <a class=" btn btn-white btn-success" href="/Intranet/emp/ENuevaPropuestaAdd.htm?cli=${cliente.nif}" data-rel="tooltip">
                Agregar
            </a>
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/ELtaClientesPropuesta.htm" data-rel="tooltip">
                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green tooltip-success" data-rel="tooltip" href="/Intranet/emp/EupdatePropuesta.htm?idP=${item.id}" title="Actualizar">
                                                   <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>
                                                <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/EconsultarPropuesta.htm?idP=${item.id}" title="Consultar">
                                                   <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                </a>    
                                                <a class="orange tooltip-warning" data-rel="tooltip" href="/Intranet/emp/EPresupuesto.htm?idP=${item.id}" title="Presupuesto">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                <li>
                                                                            <a href="/Intranet/emp/EupdatePropuesta.htm?idP=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                ...
                                                                <li>
                                                                            <a href="/Intranet/emp/EconsultarPropuesta.htm?idP=${item.id}" class="tooltip-info" data-rel="tooltip" title="Consultar">
                                                                                    <span class="blue">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/EPresupuesto.htm?idP=${item.id}" class="tooltip-warning" data-rel="tooltip" title="Presupuesto">
                                                                                    <span class="orange">
                                     ...
                                     <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="green tooltip-success" data-rel="tooltip" href="/Intranet/emp/EcontratarPresupuesto.htm?idP=${item.id}" title="Contratar">
                                                   <i class="ace-icon glyphicon glyphicon-tags bigger-130"></i>
                                                </a>    
                                                <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/EenviarPresupuesto.htm?idP=${item.id}" title="Enviar Presupuesto">
                                                   <i class="ace-icon fa fa-envelope-o bigger-130"></i>
                                                </a>    
                                                <a class="grey " data-rel="tooltip" href="/Intranet/emp/EverPresupuestoPdf.htm?idP=${item.id}" title="Ver Presupuesto">
                                                   <i class="ace-icon fa fa-eye bigger-130"></i>
                                                </a>    
                                                    <c:if test="${item.descuentoproveedor>0}">
                                                   <a class="grey " data-rel="tooltip" href="/Intranet/emp/EverPresupuestoDescuentoPdf.htm?idP=${item.id}" title="Ver Presupuesto Descuento">
                                                   <i class="ace-icon fa fa-eye bigger-130"></i>
                                                </a> 
                                                   </c:if>
                                            </div>
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/EcontratarPresupuesto.htm?idP=${item.id}" class="tooltip-success" data-rel="tooltip" title="Contratar">
                                                                                    <span class="green">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/EenviarPresupuesto.htm?idP=${item.id}" class="tooltip-info" data-rel="tooltip" title="Enviar_Presupuesto">
                                                                                    <span class="blue">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/EverPresupuestoPdf.htm?idP=${item.id}" class="" data-rel="tooltip" title="Ver Presupuesto">
                                                                                    <span class="grey">
                                                                    ...
                                                                    <c:if test="${item.descuentoproveedor>0}">
                                                                    <li>
                                                                            <a href="/Intranet/emp/EverPresupuestoDescuentoPdf.htm?idP=${item.id}" class="" data-rel="tooltip" title="Ver_Presupuesto_Descuento">
                                                                                    <span class="grey">
                                                                                            <i class="ace-icon fa fa-eye bigger-120"></i>
                                                                                    </span>
                                                                            </a>
                                            ...
                                            <c:if test="${item.plantilla==0}">
                                                <c:if test="${existePlantilla>0}">
                                                    <c:forEach items="${ltaPlantillas}" var="item2">
                                                        <a class="orange tooltip-warning" data-rel="tooltip" href="/Intranet/emp/EAsignarPlantilla.htm?nifC=${cliente.nif}&idPlan=${item2.id}&idP=${item.id}" title="${item2.descripcion}">
                                    ...
                                    <td>
                                        <c:if test="${item.estado==1}">
                                            <a class="green tooltip-success" data-rel="tooltip" href="/Intranet/emp/EActivarPresupuesto.htm?idP=${item.id}" title="Activar">
                                                <i class="ace-icon glyphicon glyphicon-ok bigger-130"></i>
                                             </a>
                                             <a class="red tooltip-error" data-rel="tooltip" href="/Intranet/emp/ERechazarPresupuesto.htm?idP=${item.id}" title="Rechazar">
                                                <i class="ace-icon glyphicon glyphicon-remove bigger-130"></i>
                                             </a>
                                        </c:if>
                                        <c:if test="${item.estado==3}">
                                            <a class="green tooltip-success" data-rel="tooltip" href="/Intranet/emp/EActivarPresupuesto.htm?idP=${item.id}" title="Rechazado_Volver_Activar">
                                                <i class="ace-icon glyphicon glyphicon-ok bigger-130"></i>
                                             </a> 
                                        ...
                                        <c:if test="${item.estado==4}">
                                         ...
                                         <a class="red tooltip-error" data-rel="tooltip" href="/Intranet/emp/ERechazarPresupuesto.htm?idP=${item.id}" title="Activo_opcion_Rechazar">
                                           <i class="ace-icon glyphicon glyphicon-remove bigger-130"></i>
                                        </a>  
                                        </c:if>
                                    </td>
