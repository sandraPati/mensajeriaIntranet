...
<div class="page-header">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-warning" href="/Intranet/emp/EupdatePresupuesto2.htm?idPres=${idPresUpd}&idP=${idPropUpd}" data-rel="tooltip">
                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="green tooltip-success" data-rel="tooltip" href="/Intranet/emp/EupdatePresupuesto5.htm?idE=${item.id}" title="Seleccionar Paños">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    <li>
                                                                            <a href="/Intranet/emp/EupdatePresupuesto5.htm?idE=${item.id}" class="tooltip-success" data-rel="tooltip" title="Seleccionar Paños">
                                                                                    <span class="green">
