                    ...
                    <tbody>
                        <c:forEach items="${ltaCapitulos}" var="item">
                            <tr>
                                    ...
                                    <td>
                                        <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/EverPresupuesto.htm?idPres=${item.id}&idP=${prop.id}" title="Ver_Presupuesto"><i class="ace-icon fa  fa-pencil-square-o bigger-130"></i></a>
                                        <a class="red tooltip-error" data-rel="tooltip" href="/Intranet/emp/EdeletePresupuestoGCap.htm?idPres=${item.id}&idP=${prop.id}" title="Eliminar">
