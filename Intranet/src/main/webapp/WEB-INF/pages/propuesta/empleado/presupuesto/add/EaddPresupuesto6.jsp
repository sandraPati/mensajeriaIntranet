...
<div class="page-header">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-warning" href="/Intranet/emp/EaddPresupuesto5.htm?idE=${idE}&idP=${idP}&idPre=${idPre}&idSC=${idSC}&idPresup=${idPresup}" data-rel="tooltip">
...
<div class="row">
    ...
    <div class="col-lg-2 align-right">
        ...
        <a class="btn btn-success col-xs-12 col-sm-4 col-md-3 col-lg-12 "  href="/Intranet/emp/EaddPresupuestoG.htm?idP=${idP}&idPre=${idPre}&idSC=${idSC}&idPresup=${idPresup}">
