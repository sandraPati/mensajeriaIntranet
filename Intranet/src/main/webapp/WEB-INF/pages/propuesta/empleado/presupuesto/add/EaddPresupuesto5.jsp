...
<div class="page-header">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-warning" href="/Intranet/emp/EaddPresupuesto4.htm?idP=${p.id}&idPre=${idPre}&idSC=${idSC}" data-rel="tooltip">
 ...
 <div class="row">
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <div id="SubCapCheck">
                                            ...
                                            <a class="blue tooltip-info" data-rel="tooltip"href="/Intranet/emp/EaddPresupuesto6.htm?idE=${idE}&idP=${p.id}&idPre=${idPre}&idSC=${idSC}&idPresup=${idPresup}&idPsp=${idpresup_sup}&idPano=${item.id}"title="Asignar_Ventanas">
    ...
    <div class="col-lg-2 align-right">
        ...
        <a class="btn btn-success col-xs-12 col-sm-4 col-md-3 col-lg-12 "  href="/Intranet/emp/EaddPresupuestoG.htm?idP=${p.id}&idPre=${idPre}&idSC=${idSC}&idPresup=${idPresup}">
