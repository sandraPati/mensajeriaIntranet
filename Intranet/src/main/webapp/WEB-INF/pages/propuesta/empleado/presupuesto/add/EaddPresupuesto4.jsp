...
<div class="page-header">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-warning" href="/Intranet/emp/EaddPresupuesto2.htm?idP=${p.id}&idC=${idC}" data-rel="tooltip">
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <div id="SubCapCheck">
                                            ...
                                            <a class="blue tooltip-info" data-rel="tooltip"href="/Intranet/emp/EaddPresupuesto5.htm?idE=${item.id}&idP=${p.id}&idPre=${idPre}&idSC=${idSC}&idPresup=${pres1}"title="Asignar_Panos">
