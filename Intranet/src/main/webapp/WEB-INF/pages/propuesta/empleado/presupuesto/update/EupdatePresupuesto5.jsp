...
<div class="page-header">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-warning" href="/Intranet/emp/EupdatePresupuesto4.htm" data-rel="tooltip">
 ...
 <div class="row">
                                    ...
                                    <td>
                                        ...
                                        <c:if test="${encont==0}">
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/EupdatePresupuesto6.htm?idPano=${item.id}&idE=${idE}" title="Agregar al Presupuesto">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    <li>
                                                                            <a href="/Intranet/emp/EupdatePresupuesto6.htm?idPano=${item.id}&idE=${idE}" class="tooltip-info" data-rel="tooltip" title="Agregar al Presupuesto">
                                                                                    <span class="blue">
                                            ...
                                            <c:if test="${encont==1}"> 
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="red tooltip-error" data-rel="tooltip" href="/Intranet/emp/EupdatePresupuesto7.htm?idPano=${item.id}&idE=${idE}" title="Quitar">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    <li>
                                                                            <a href="/Intranet/emp/EupdatePresupuesto7.htm?idPano=${item.id}&idE=${idE}" class="tooltip-error" data-rel="tooltip" title="Quitar">
                                                                                    <span class="red">
    ...
    <div class="row">
     ...
     <div class="col-lg-2 align-right">
        ...
        <a class="btn btn-success col-xs-12 col-sm-4 col-md-3 col-lg-12 "  href="/Intranet/emp/EupdatePresupuestoG.htm?idE=${idE}">
