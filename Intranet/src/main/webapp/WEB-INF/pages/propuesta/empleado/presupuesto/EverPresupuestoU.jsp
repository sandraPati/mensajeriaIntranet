                                ...
                                <td>
                                   ...
                                   <td><c:out value="${item.monto}" /></td>
                                    <td>
                                                ...
                                                <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/EverPresupuestoSC.htm?idPres=${item.id}&idP=${idP}&idPP=${idPres}" title="Consultar">
                                                    <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                </a>    
                                                          
                                                <a class="red tooltip-error" data-rel="tooltip" href="/Intranet/emp/EdeletePresupuestoG.htm?idPres=${item.id}&idP=${idP}&idPP=${idPres}" title="Eliminar">
