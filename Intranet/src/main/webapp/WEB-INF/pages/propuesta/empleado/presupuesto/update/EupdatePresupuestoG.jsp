...
<div class="page-header">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-warning" href="/Intranet/emp/EupdatePresupuesto5.htm?idE=${idE}" data-rel="tooltip">
...
<div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
          <form:form id="form1" class="form-horizontal" role="form" action="" method="POST" commandName="prec">
              <form:hidden id="id" path="id" value="${prec.id}"/>    
              <form:hidden id="propuesta_id" path="propuesta_id" value="${prec.propuesta_id}"/>
                ...
                <form:hidden id="descripcion" path="descripcion" value="${prec.descripcion}"/>
                <form:hidden id="cantidad" path="cantidad" value="${prec.cantidad}"/>
                ...
                <div class="form-group" id="Otro">
                        ...
                        <div class="col-sm-9">
                            <form:input type="text" id="descripcionmetros" path="descripcionmetros" value="${prec.descripcionmetros}" class="col-xs-10 col-sm-4"/>
                        </div>
                </div>
                <div class="form-group" id="Otro">
                        ...
                        <div class="col-sm-9">
                            <form:input type="text" id="cantidadmetros" path="cantidadmetros" value="${prec.cantidadmetros}"class="col-xs-10 col-sm-4" required="true"/>
                        </div>
                </div>
                <div class="form-group">
