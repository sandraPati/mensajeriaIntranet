    ...
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/sup/UpdateDatosSupervisor.htm?nif=${empleado.nif}" data-rel="tooltip">
...
<div class="col-lg-8 ">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/sup/addEstudioSupervisor.htm" data-rel="tooltip">
          Agregar
        </a>
    </div>
                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/Intranet/sup/updateEstudioSupervisor.htm?id=${item.id}" title="Actualizar">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="/Intranet/sup/deleteEstudioSupervisor.htm?id=${item.id}" title="Eliminar">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/updateEstudioSupervisor.htm?id=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                     ...
                                                                     <li>
                                                                            <a href="/Intranet/sup/deleteEstudioSupervisor.htm?id=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
...
<div class="col-lg-8 ">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/sup/addIdiomaSupervisor.htm" data-rel="tooltip">
          Agregar
        </a>
    </div>
                            ...
                            <tr>
                                   ...
                                   <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/Intranet/sup/updateIdiomaSupervisor.htm?id=${item.id}" title="Actualizar">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                     <a class="red" href="/Intranet/sup/deleteIdiomaSupervisor.htm?id=${item.id}" title="Eliminar">
                                                            <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                    </a>        
                                            </div>
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/updateIdiomaSupervisor.htm?id=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                                            <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/deleteIdiomaSupervisor.htm?id=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
                                                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
...
<div class="col-lg-8 ">
    ...
    <div class="col-lg-4 align-right">
        ...
        <a class=" btn btn-white btn-success" href="/Intranet/sup/addConocimientoSupervisor.htm" data-rel="tooltip">
          Agregar
        </a>
    </div>
                            ...
                            <tr>
                                   ...
                                   <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/Intranet/sup/updateConocimientoSupervisor.htm?id=${item.id}" title="Actualizar">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="/Intranet/sup/deleteConocimientoSupervisor.htm?id=${item.id}" title="Eliminar">
                                                            <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                    </a>        
                                            </div>
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/updateConocimientoSupervisor.htm?id=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                                            <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/deleteConocimientoSupervisor.htm?id=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
                                                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
...
<div class="col-lg-8 ">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/sup/addExperienciaLaboralSupervisor.htm" data-rel="tooltip">
          Agregar
        </a>
    </div>
...
<td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/Intranet/sup/updateExperienciaLaboralSupervisor.htm?id=${item.id}" title="Actualizar">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="/Intranet/sup/deleteExperienciaLaboralSupervisor.htm?id=${item.id}" title="Eliminar">
                                                            <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                    </a>         
                                            </div>
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/updateExperienciaLaboralSupervisor.htm?id=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                                            <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/deleteExperienciaLaboralSupervisor.htm?id=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
                                                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
...
<div class="col-lg-8">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/sup/FuturoEmpleoSupervisor.htm" data-rel="tooltip">
