...
<div class="page-header">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-warning" href="/Intranet/emp/EverAgenda.htm" data-rel="tooltip">
        ...
        <!-- PAGE CONTENT BEGINS -->
          <form:form id="form1" class="form-horizontal" role="form" action="" method="POST" commandName="tarea">
              ...
              <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <label class="col-sm-9 "> ${tarea.sup.nif} </label>
                ...
                <div class="form-group" id="clienteAsig">
                        ...
                        <div class="col-sm-9">
                            <form:select id="nifcliente" name="nifcliente" path="nifcliente" class="col-xs-10 col-sm-5" data-placeholder="Choose a State...">
