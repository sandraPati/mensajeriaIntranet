...
<div class="page-header">
    <div class="row">
        <div class="col-lg-8">
        <h1>
               Tareas de Empleado<div id="resultS"></div>
                <small>
                        <i class="ace-icon fa fa-angle-double-right"></i>
                       ${empleado.nif} ${empleado.apellidos}, ${empleado.nombre}
                </small>
        </h1>
        </div>
         <div class="col-lg-4 align-right">
            ...
            <a class=" btn btn-white btn-warning" href="/Intranet/sup/verAgendaEmpleados.htm" data-rel="tooltip">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group" id="Otro">
                        ...
                        <div class="col-sm-9">
                            <form:select id="tipotarea_id" name="tipotarea_id" path="tipotarea_id"  data-placeholder="Choose a State..." class="col-xs-10 col-sm-10">
                                <form:option value="Visita"></form:option>
                                <form:option value="Enviar Presupuesto"></form:option>
                                <form:option value="Llamada para concretar visita"></form:option>
                                <form:option value="Llamada de seguimiento"></form:option>
          ...
          <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <form:input class="middle col-xs-10 col-sm-10" autocomplete="off" type="text" value="" id="descripcion" name="descripcion" path="descripcion" required="true"/>
                        </div>
