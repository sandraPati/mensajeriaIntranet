...
<div class="page-header">
    <div class="row">
        ...
        <div class="col-lg-4 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/sup/restaurar.htm?nif=${postulante.docuemnto_identidad}" data-rel="tooltip">
               <i class="ace-icon fa fa-undo bigger-130"></i> Restaurar
            </a>
