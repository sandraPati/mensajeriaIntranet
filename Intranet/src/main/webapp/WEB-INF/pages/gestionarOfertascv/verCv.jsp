...
<div class="page-header">
    <div class="row">
        ...
        <div class="col-lg-4 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/sup/cvEnProcesoadd.htm?nif=${postulante.docuemnto_identidad}" data-rel="tooltip">
               <i class="ace-icon fa fa-check bigger-120"></i> En Proceso
            </a>
            <a class=" btn btn-white btn-danger" href="/Intranet/sup/cvDescartadoadd.htm?nif=${postulante.docuemnto_identidad}" data-rel="tooltip">
               <i class="ace-icon fa fa-trash-o bigger-120"></i> Descartado
            </a>
        </div>   
    </div>
</div><!-- /.page-header -->
