                                        ...
                                        <img class="nav-user-photo" width="30px" height="30px"  src="/Intranet/resources/fotosPerfil/${item.nombrefotografia}" alt="${item.nombre}" />
                                            ...
                                            <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                            <a class="tooltip-info" data-rel="tooltip" href="/Intranet/sup/verCvDescartado.htm?nif=${item.docuemnto_identidad}" title="Ver Informacion">
                                                                    <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                            </a>
                                                             
                                                            
                                                            <a class="orange tooltip-warning" href="/Intranet/sup/restaurar.htm?nif=${item.docuemnto_identidad}" data-rel="tooltip"  title="Restaurar">
                                                    ...
                                                    <div class="hidden-md hidden-lg">
                                                            <div class="inline pos-rel">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                            <li>
                                                                                    <a href="/Intranet/sup/verCvDescartado.htm?nif=${item.docuemnto_identidad}" class="tooltip-info" data-rel="tooltip" title="Ver Informacion">
                                                                                            <span class="blue">
                                                                            ...
                                                                            <li>
                                                                                    <a href="/Intranet/sup/restaurar.htm?nif=${item.docuemnto_identidad}" class="tooltip-warning" data-rel="tooltip" title="Restaurar">
                                                                                            <span class="orange">
                                                                                                    <i class="ace-icon fa fa-undo bigger-120 warning"></i>
                                                                                            </span>
                                                                                    </a>
                                                                            </li>
