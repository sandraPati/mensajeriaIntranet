                                        ...
                                        <img class="nav-user-photo" width="30px" height="30px"  src="/Intranet/resources/fotosPerfil/${item.nombrefotografia}" alt="${item.nombre}" />
                                            ...
                                            <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                            <a class="tooltip-info" data-rel="tooltip" href="/Intranet/sup/verCv.htm?nif=${item.docuemnto_identidad}" title="Ver Informacion">
                                                                    <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                            </a>
                                                             
                                                            
                                                            <a class="orange tooltip-warning" href="/Intranet/sup/cvEnProcesoadd.htm?nif=${item.docuemnto_identidad}" data-rel="tooltip"  title="En Proceso">
                                                                  <i class="ace-icon fa fa-check bigger-120"></i>

                                                            </a>     

                                                            <a class="red tooltip-error" href="/Intranet/sup/cvDescartadoadd.htm?nif=${item.docuemnto_identidad}" data-rel="tooltip"  title="Descartado">
                                                    ...
                                                    <div class="hidden-md hidden-lg">
                                                            <div class="inline pos-rel">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                            <li>
                                                                                    <a href="/Intranet/sup/verCv.htm?nif=${item.docuemnto_identidad}" class="tooltip-info" data-rel="tooltip" title="Ver Informacion">
                                                                                            <span class="blue">
                                                                            ...
                                                                            <li>
                                                                                    <a href="/Intranet/sup/cvEnProcesoadd.htm?nif=${item.docuemnto_identidad}" class="tooltip-warning" data-rel="tooltip" title="En Proceso">
                                                                                            <span class="orange">
                                                                                                    <i class="ace-icon fa fa-check bigger-120 warning"></i>
                                                                                            </span>
                                                                                    </a>
                                                                            </li>
                                                                            <li>
                                                                                    <a href="/Intranet/sup/cvDescartadoadd.htm?nif=${item.docuemnto_identidad}" class="tooltip-error" data-rel="tooltip" title="Descartado">
                                                                                            <span class="red">
