    ...
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            ...
            <a class=" btn btn-white btn-warning" href="/Intranet/cli/CfichaCliente.htm" data-rel="tooltip">
            ...
            <c:forEach items="${item.ltaPanos}" var="itemPanos">
                <div class="row">
                    ...
                    <c:out value=" ${itemPanos.tipo_pano_id.nombre}" /> <c:out value=" ${itemPanos.numero}" />:
                     <c:if test="${itemPanos.tipo_pano_id.id!=1}">
                                <c:if test="${itemPanos.formapano==1}">Cuadrado</c:if>
                                <c:if test="${itemPanos.formapano==2}">Rectangulo</c:if>
                                <c:if test="${itemPanos.formapano==3}">'L'</c:if>
                                <c:if test="${itemPanos.formapano==4}">Rombo</c:if>
                                <c:if test="${itemPanos.formapano==5}">Trapecio</c:if>
                            </c:if>
                    </div>
                    ...
                    <div class="col-xs-10">
                        <div class="profile-striped col-xs-2">
                             <div class="profile-info-row">
                                <div class="profile-info-name">
                                    <c:if test="${itemPanos.tipo_pano_id.id==1}">ALTO</c:if>
                                    <c:if test="${itemPanos.tipo_pano_id.id!=1}">
                                        <c:if test="${itemPanos.formapano==1}">a</c:if>
                                        <c:if test="${itemPanos.formapano==2}">a</c:if>
                                        <c:if test="${itemPanos.formapano==3}">a</c:if>
                                        <c:if test="${itemPanos.formapano==4}">D</c:if>
                                        <c:if test="${itemPanos.formapano==5}">b</c:if>
                                    </c:if>
                                    : <c:out value=" ${itemPanos.alto}" />m
                                    </div>
                            </div>
                        </div>    
                        <c:if test="${itemPanos.tipo_pano_id.id==1}">
                                ...
                                <div class="profile-striped col-xs-2">        
                                    <div class="profile-info-row">
                                        <div class="profile-info-name">  
                                        LARGO: <c:out value=" ${itemPanos.largo}" /> 
                                        </div>
                                    </div>
                                </div>        
                        ...
                        <c:if test="${itemPanos.tipo_pano_id.id!=1}">
                            <c:if test="${itemPanos.formapano==2}"> 
                                <div class="profile-striped col-xs-2">        
                                    <div class="profile-info-row">
                                        <div class="profile-info-name">  
                                        b:<c:out value=" ${itemPanos.largo}" /> 
                                        </div>
                                    </div>
                                </div>        
                            </c:if>
                            <c:if test="${itemPanos.formapano==3}"> 
                                <div class="profile-striped col-xs-2">        
                                    <div class="profile-info-row">
                                        <div class="profile-info-name">  
                                        b:<c:out value=" ${itemPanos.largo}" /> 
                                ...
                                <div class="profile-striped col-xs-2">        
                                    <div class="profile-info-row">
                                        <div class="profile-info-name">  
                                        d:<c:out value=" ${itemPanos.lado4}" /> 
                                        </div>
                                    </div>
                                </div>          
                            </c:if>
                            <c:if test="${itemPanos.formapano==4}"> 
                                <div class="profile-striped col-xs-2">        
                                    <div class="profile-info-row">
                                        <div class="profile-info-name">  
                                        d: <c:out value=" ${itemPanos.largo}" /> 
                                        </div>
                                    </div>
                                </div>        
                            </c:if>
                            <c:if test="${itemPanos.formapano==5}"> 
                                <div class="profile-striped col-xs-2">        
                                    <div class="profile-info-row">
                                        <div class="profile-info-name">  
                                        B: <c:out value=" ${itemPanos.largo}" /> 
