                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/sup/fichaverPropuesta.htm?idP=${item.id}" title="Gestionar Proyecto">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/fichaverPropuesta.htm?idP=${item.id}" class="tooltip-info" data-rel="tooltip" title="Gestionar_Proyecto">
                                                                                    <span class="blue">
                                      ...
                                      <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="grey " data-rel="tooltip" href="/Intranet/sup/FichaverPresupuestoPdf.htm?idP=${item.id}" title="Ver Presupuesto">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                     <li>
                                                                            <a href="/Intranet/sup/FichaverPresupuestoPdf.htm?idP=${item.id}" class="" data-rel="tooltip" title="Ver Presupuesto">
                                                                                    <span class="grey">
                    ...
                    <tbody>
                        <c:forEach items="${ltaProyectos}" var="item">
                            <tr>
                                    ...
                                    <td>
                                         <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="grey " data-rel="tooltip" href="/Intranet/sup/FichaverContratoPdf.htm?idP=${item.id}" title="Ver Contrato">
                                                   <i class="ace-icon fa fa-eye bigger-130"></i>
                                                </a>   
                                                <a class="grey " data-rel="tooltip" href="/Intranet/sup/verFichaPlanObraPdf.htm?idP=${item.id}" title="Ver Plan de Obra">
                                                   <i class="ace-icon fa fa-eye bigger-130"></i>
                                                </a>    
                                                <a class="grey " data-rel="tooltip" href="/Intranet/sup/FichaverPresupuestoPdf.htm?idP=${item.id}" title="Ver Presupuesto">
                                                   <i class="ace-icon fa fa-eye bigger-130"></i>
                                                </a>  
                                                <a class="grey " data-rel="tooltip" href="/Intranet/sup/FichaverCertificacionesPdf.htm?idP=${item.id}" title="Ver Certificaciones">
                                                   <i class="ace-icon fa fa-eye bigger-130"></i>
                                                </a>    
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                <li>
                                                                            <a href="/Intranet/sup/FichaverContratoPdf.htm?idP=${item.id}" class="" data-rel="tooltip" title="Ver_Contrato">
                                                                                    <span class="grey">
                                                                                            <i class="ace-icon fa fa-eye bigger-120"></i>
                                                                                    </span>
                                                                            </a>
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/verFichaPlanObraPdf.htm?idP=${item.id}" class="" data-rel="tooltip" title="Ver_PlanObra">
                                                                                    <span class="grey">
                                                                                            <i class="ace-icon fa fa-eye bigger-120"></i>
                                                                                    </span>
                                                                            </a>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/sup/FichaverCertificacionesPdf.htm?idP=${item.id}" class="" data-rel="tooltip" title="Ver_Certificaciones">
                                                                                    <span class="grey">
                                                                                            <i class="ace-icon fa fa-eye bigger-120"></i>
                                                                                    </span>
                                                                            </a>
