...
<div id="wrapper">
        ...
        <h1 align="center">Semana por Fecha Inicio y Fin</h1><br/>
       ...
       <form:form id="form1" action="" method="GET" commandName="report">
           ...
           <tr>
            <td>&nbsp;</td>
            <td align="center">
                Fecha Inicio:&nbsp;<form:input id="fecha1" path="fecha1" required="true"/>
            </td>
           </tr> 
           <tr>
            <td>&nbsp;</td>
            <td align="center">
                Fecha Fin:&nbsp;<form:input id="fecha2" path="fecha2" required="true"/>
            </td>
           </tr> 
           <tr>
