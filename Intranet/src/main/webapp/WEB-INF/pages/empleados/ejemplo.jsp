															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                                                                                                ...
                                                                                                                                                <li>
																			<a href="/Intranet/sup/updateNomina.htm?idN=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar Nomina">
																				<span class="green">
																		...
																		<li>
																			<a href="/Intranet/sup/deleteNomina.htm?nif=${nif}&idC=${cont.id}&idN=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar Nomina">
																				<span class="red">
