...
<div class="page-header">
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 ">
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/fotoEmpleado.htm" data-rel="tooltip">
                    ...
                    <div class="col-xs-12 col-sm-3 center">
                            <div>
                                    ...
                                    <span class="profile-picture">
                                            <img id="avatar" class="editable img-responsive" alt="${empleado.apellidos}" src="/Intranet/resources/fotosPerfil/${empleado.nombrefotografia}" />
                                    </span>
