...
<div class="page-header">
    <div class="row">
        <div class="col-lg-8">
        <h1>
        Actualizar Usuario y Contraseña DECORAKIA
        <small>
                            ...
                            <form:form id="form1" class="form-horizontal" role="form" action="" method="POST" commandName="usu">
                                <!-- #section:pages/profile.info -->
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                             <form:input id="contrasenna" type="password" class="col-xs-10 col-sm-5" placeholder="Repetir Contraseña" path="correoContreasenna" />
