    ...
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/UpdateDatos.htm?nif=${empleado.nif}" data-rel="tooltip">
...
<div class="col-lg-8 ">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/emp/addEstudioEmp.htm" data-rel="tooltip">
          Agregar
        </a>
    </div>
                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/Intranet/emp/updateEstudioEmp.htm?id=${item.id}" title="Actualizar">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="/Intranet/emp/deleteEstudioEmp.htm?id=${item.id}" title="Eliminar">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/updateEstudioEmp.htm?id=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                     ...
                                                                     <li>
                                                                            <a href="/Intranet/emp/deleteEstudioEmp.htm?id=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
...
<div class="col-lg-8 ">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/emp/addIdiomaEmp.htm" data-rel="tooltip">
          Agregar
        </a>
    </div>
                            ...
                            <tr>
                                   ...
                                   <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/Intranet/emp/updateIdiomaEmp.htm?id=${item.id}" title="Actualizar">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                     <a class="red" href="/Intranet/emp/deleteIdiomaEmp.htm?id=${item.id}" title="Eliminar">
                                                            <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                    </a>        
                                            </div>
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/updateIdiomaEmp.htm?id=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                                            <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/deleteIdiomaEmp.htm?id=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
                                                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
...
<div class="col-lg-8 ">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/emp/addConocimientoEmp.htm" data-rel="tooltip">
          Agregar
        </a>
    </div>
                            ...
                            <tr>
                                   ...
                                   <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/Intranet/emp/updateConocimientoEmp.htm?id=${item.id}" title="Actualizar">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="/Intranet/emp/deleteConocimientoEmp.htm?id=${item.id}" title="Eliminar">
                                                            <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                    </a>        
                                            </div>
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/updateConocimientoEmp.htm?id=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                                            <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/deleteConocimientoEmp.htm?id=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
                                                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
...
<div class="col-lg-8 ">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/emp/addExperienciaLaboralEmp.htm" data-rel="tooltip">
          Agregar
        </a>
    </div>
...
<td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/Intranet/emp/updateExperienciaLaboralEmp.htm?id=${item.id}" title="Actualizar">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="/Intranet/emp/deleteExperienciaLaboralEmp.htm?id=${item.id}" title="Eliminar">
                                                            <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                    </a>         
                                            </div>
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/updateExperienciaLaboralEmp.htm?id=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                                            <i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/emp/deleteExperienciaLaboralEmp.htm?id=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
                                                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                                                    </span>
                                                                            </a>
...
<div class="col-lg-8">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/emp/FuturoEmpleoEmp.htm" data-rel="tooltip">
