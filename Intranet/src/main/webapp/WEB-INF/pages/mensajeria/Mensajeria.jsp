...
<script type="text/javascript">
   var intervalId = 0;
    intervalId = setInterval(crunchifyAjaxMens, 9000);
</script>
                                    ...
                                    <div class="input-group">
                                        <form:input type="text" id="asunto" path="asunto" class="form-control col-xs-10 col-sm-3 col-lg-12"/>     
                                            ...
                                            <span class="input-group-btn">
                                                    ...
                                                    <a href="/Intranet/sup/Mensajeria.htm?nifU=${chatadd.nifReceptor}" class="btn btn-white btn-info btn-bold">
        ...
        <div class="widget-box widget-color-blue">
                ...
                <div class="widget-body">
                        ...
                        <div class="widget-main padding-4 scrollable" data-size="419">
                                <div class="content" id="resultLtaE">
                                    ...
                                    <a href="/Intranet/sup/Mensajeria.htm?nifU=${item2.nif}">${item2.nombre}</a>
...
<script>
	$(document).ready(function() {
		...
		$('#search').autocomplete({
			serviceUrl: '/Intranet/sup/ajaxBuscar.json',
			paramName: "nombre",
			delimiter: ",",
		    ...
		    transformResult: function(response) {
		        ...
		        return {
		            ...
		            suggestions: $.map($.parseJSON(response), function(item) {
		            	json2=json2+"<div>"+    
                                    "<img src='/Intranet/resources/fotosPerfil/"+item.nombrefotografia+"' width='25px' height='25px' alt='' class='img-circle' />"+

                                    "<a href='/Intranet/sup/Mensajeria.htm?nifU="+item.nif+"'>"+item.nombre+"</a>";
                                      if(item.inicioS===1){
