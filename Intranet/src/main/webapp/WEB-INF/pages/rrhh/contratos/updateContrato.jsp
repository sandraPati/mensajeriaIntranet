    ...
    <div class="col-xs-12">
        ...
        <div class="profile-striped col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="username"><c:out value="${contrato.nif_empleado.nif}" /></span>
                    </div>
                </div>
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="username"><c:out value="${contrato.nif_empleado.nombre}" /></span>
                    </div>
                </div>
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="username"><c:out value="${contrato.nif_empleado.apellidos}" /></span>
                    </div>
                </div>
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="username"><c:out value="${contrato.nif_empleado.numero_afiliacionss}" /></span>
                    </div>
                </div>
        ...
        <div class="profile-striped col-xs-12 col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                            <span class="editable" id="username"><c:out value="${contrato.nif_empleado.pais}" /></span>
                    </div>
            </div>
            <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                            <span class="editable" id="username"><c:out value="${contrato.nif_empleado.provincia}" /></span>
                    </div>
            </div>
            ...
            <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                            <span class="editable" id="username"><c:out value="${contrato.nif_empleado.poblacion}" /></span>
                    </div>
            </div>
            <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                            <span class="editable" id="username"><c:out value="${contrato.nif_empleado.direccion}" /></span>
                    </div>
            </div>
            <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                            <span class="editable" id="username"><c:out value="${contrato.nif_empleado.nivel_formativo}" /></span>
                    </div>
            </div>
        </div>
            ...
            <div class="row">
                    <div class="col-xs-12">
                            ...
                            <form:form id="form1" class="form-horizontal" role="form" action="" method="POST" commandName="contrato">
                                    ...
                                    <form:hidden id="id" path="id" value="${contrato.id}"/>
