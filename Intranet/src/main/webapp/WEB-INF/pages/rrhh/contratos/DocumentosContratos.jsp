                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <td>
                                                                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                                                                            <a class="tooltip-info" data-rel="tooltip" href="/Intranet/sup/verContratos.htm?nif=${item.nif}" title="Ver Contratos">
                                                                                                    ...
                                                                                                    <div class="hidden-md hidden-lg">
                                                                                                            <div class="inline pos-rel">
                                                                                                                    ...
                                                                                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                                                                            <li>
                                                                                                                                    <a href="/Intranet/sup/verContratos.htm?nif=${item.nif}" class="tooltip-info" data-rel="tooltip" title="Ver Contratos">
                                                                                                                                            <span class="blue">
