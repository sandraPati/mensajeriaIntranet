        ...
        <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                        ...
                        <div class="form-group">
                           ...
                           <form:hidden id="nif_empleado"  path="nominaId.nif_empleado.nif" />
                            <form:hidden id="c"  path="nominaId.c.id" />
                        </div>
                        <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> </label>
                                ...
                                <div class="col-sm-9">
                                       <button type="subtmit" class="btn btn-info col-xs-12 col-sm-4 col-md-3 col-lg-5">Agregar</button>
                                </div>
                        </div>
