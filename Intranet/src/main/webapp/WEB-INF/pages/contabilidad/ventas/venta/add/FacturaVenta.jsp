...
<div class="page-header">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/sup/addProductoVenta.htm" data-rel="tooltip">
...
<div class="col-xs-12">
        ...
        <c:forEach items="${tiendaV}" var="ti">
          <form:form id="form1" action="/Intranet/sup/AgregarPVenta.htm" method="post" commandName="detalleC"> 
            <form:hidden id="id" path="id" value="${ti.id}"/>
                                ...
                                <%}else{%>
                               <td> 
                                <a href="/Intranet/sup/QuitarPVenta.htm?id=${ti.id}"><span class="red"><i class="ace-icon glyphicon glyphicon-remove bigger-130"></i></span></a>
                               </td> 
                                <%}
                                    %>
                                    </tr>
    ...
    <div class="form-group">
            ...
            <div class="col-sm-2">
                <a class="btn btn-success col-xs-12 col-sm-4 col-md-3 col-lg-12" href="/Intranet/sup/addFacturaVenta.htm" data-rel="tooltip">
