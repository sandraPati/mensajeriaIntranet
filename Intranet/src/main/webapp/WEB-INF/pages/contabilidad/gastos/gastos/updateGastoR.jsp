          ...
          <form:form id="form1" class="form-horizontal" role="form" action="" method="POST" commandName="gasto">
                ...
                <div class="col-sm-10">
                    <div class="form-group" >
                        <label class="col-sm-12 " for="form-field-1"> Empleado </label>

                        <div class="col-sm-12">
                            ${gasto.nifempleado.nif} - ${gasto.nifempleado.nombre}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <form:select id="tipogasto_id" name="tipogasto_id" path="tipogasto_id.id" class="chosen-select col-xs-10 col-sm-12" data-placeholder="Elegir Tipo de Gasto...">
                                <option value="">  </option>
            ...
            <div class="col-xs-12 col-sm-12">
                            <div>
                                    ...
                                    <span class="profile-picture">
                                            <img id="avatar" class="editable img-responsive" width="300px" height="300px" onclick="javascript:this.width=1000;this.height=1500" ondblclick="javascript:this.width=300;this.height=300" alt="${nombreimg}" src="/Intranet/resources/fotosfacturas/${nombreimg}" />
                                    </span>
                                    ...
                                    <div class="width-40 label label-info label-xlg arrowed-in arrowed-in-right">
                                            <div class="inline position-relative">
                                                    <a href="/Intranet/sup/updateGastoRF.htm?id=${gasto.id}" >
                                                            <i class="ace-icon fa fa-circle light-green"></i>
                                                            &nbsp;
                                                            <span class="white">${nombreimg} </span>
                                                    </a>
