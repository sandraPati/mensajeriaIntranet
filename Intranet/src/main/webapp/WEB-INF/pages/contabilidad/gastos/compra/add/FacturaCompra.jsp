...
<div class="page-header">
    ...
    <div class="col-lg-4 align-right">
        <a class=" btn btn-white btn-success" href="/Intranet/sup/addProducto.htm" data-rel="tooltip">
...
<div class="col-xs-12">
    ...
    <div class="form-group">
            ...
            <div class="col-sm-2">
                <a class="btn btn-success col-xs-12 col-sm-4 col-md-3 col-lg-12" href="/Intranet/sup/addFacturaCompra.htm" data-rel="tooltip">
