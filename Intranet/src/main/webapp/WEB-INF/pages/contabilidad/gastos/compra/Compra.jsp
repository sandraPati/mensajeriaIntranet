    ...
    <div class="row">
        ...
        <small>
         ...
         <div class="col-lg-4 align-right">
            <a class=" btn btn-sm btn-success" href="/Intranet/sup/FacturaCompra.htm" data-rel="tooltip">
                ...
                <tbody>
                    <c:forEach items="${compraListbox}" var="item">
                        <tr>
                                ...
                                <td>
                                    <c:if test="${item.retificativo==true}">
                                    SI
                                    </c:if>
                                    <c:if test="${item.retificativo==false}">
                                    NO
                                    </c:if>
                                </td>
                                ...
                                <td>
                                    <c:if test="${item.estado==0}">
                                        <a id="factPagada" name="factP" class="orange tooltip-warning" data-rel="tooltip"  href="/Intranet/sup/FacturaPagada.htm?id=${item.num}" title="Factura Pagada">
                                            <i class="ace-icon fa fa-square-o bigger-130"></i>
                                        </a>
                                    </c:if>
                                    <c:if test="${item.estado==1}">
                                        <a class="green tooltip-success" data-rel="tooltip"  href="/Intranet/sup/FacturaPendiente.htm?id=${item.num}" title="Factura Pendiente">
                                ...
                                <td>
                                             ...
                                             <a class="green tooltip-success" data-rel="tooltip"  href="/Intranet/sup/updateFC.htm?id=${item.num}" title="Actualizar">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a class="red tooltip-error" data-rel="tooltip"  href="/Intranet/sup/deleteFacturaCompra.htm?id=${item.num}" title="Eliminar">
                                                    <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                            </a> 
                                            <a class="blue tooltip-info" data-rel="tooltip"  href="/Intranet/sup/verFacturaCompraPdf.htm?id=${item.num}" title="Ver Factura">
                                            ...
                                            <a class="orange tooltip-warning" data-rel="tooltip"  href="/Intranet/sup/updateFacturaCompraRF.htm?id=${item.num}" title="Actualizar_Foto_Factura">
