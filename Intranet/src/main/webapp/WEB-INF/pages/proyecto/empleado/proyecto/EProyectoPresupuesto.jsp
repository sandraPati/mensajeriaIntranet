    ...
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            ...
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/EProyecto.htm?idP=${prop.id}" data-rel="tooltip">
                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/EPlanObra.htm?idPres=${item.id}" title="Consultar">
                                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                </a> 
                                                <a class="green tooltip-success" data-rel="tooltip" href="/Intranet/emp/EaddPlanObra.htm?idPres=${item.id}" title="Agregar Plan de Obra">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    <li>
                                                                            <a href="/Intranet/emp/EPlanObra.htm?idPres=${item.id}" class="tooltip-info" data-rel="tooltip" title="Consultar">
                                                                                    <span class="blue">
                                                                     ...
                                                                     <li>
                                                                            <a href="/Intranet/emp/EaddPlanObra.htm?idPres=${item.id}" class="tooltip-success" data-rel="tooltip" title="Agregar Plan de Obra">
                                                                                    <span class="green">
