                        ...
                        <tr>
                                ...
                                <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/EverPropuestasP.htm?nifC=${item.nif}" title="Ver Proyectos">
                                        ...
                                        <div class="hidden-md hidden-lg">
                                                <div class="inline pos-rel">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                <li>
                                                                        <a href="/Intranet/emp/EverPropuestasP.htm?nifC=${item.nif}" class="tooltip-info" data-rel="tooltip" title="Ver Proyectos">
                                                                                <span class="blue">
