    ...
    <div class="row">
        ...
        <h1>
         ...
         <div class="col-lg-4 align-right">
            ...
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/EverPropuestasP.htm?nifC=${prop.cliente_nif.nif}" data-rel="tooltip">
...
<div class="row">
    ...
    <div class="col-xs-12">
        <form:form id="form1" action="/Intranet/emp/EverCertificacionesSemanaPdf.htm" method="POST" commandName="certificacion"> 
        ...
        <form:form id="form2" action="/Intranet/emp/EenviarCertificacionSemana.htm" method="POST" commandName="certificacion"> 
                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/EProyectoPresupuestoC.htm?idPres=${item.id}&idP=${prop.id}" title="Ver Sub Capitulos">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    <li>
                                                                            <a href="/Intranet/emp/EProyectoPresupuestoC.htm?idPres=${item.id}&idP=${prop.id}" class="tooltip-info" data-rel="tooltip" title="Ver Sub Capitulos">
                                                                                    <span class="blue">
