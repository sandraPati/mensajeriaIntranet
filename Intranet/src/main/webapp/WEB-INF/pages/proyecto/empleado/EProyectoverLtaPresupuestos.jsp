...
<div class="page-header">
    <div class="row">
       ...
       <div class="col-lg-4 align-right">
            ...
            <a class=" btn btn-white btn-warning" href="/Intranet/emp/EverPropuestasP.htm?nifC=${nifC}" data-rel="tooltip">
                ...
                <tbody>
                    <c:forEach items="${lta}" var="item">
                        <tr>
                                ...
                                <td>
                                    <a class="blue tooltip-info" data-rel="tooltip" href="/Intranet/emp/EProyectoverPPresupuesto.htm?nifC=${nifC}&idProy=${idProy}&idP=${item.id}" title="ver Presupuesto">
