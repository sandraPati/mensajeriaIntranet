...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>  
                 <link rel="stylesheet" href="/Intranet/resources/assets/css/colorbox.css" />   
...
<div class="col-xs-12">
        ...
        <div>
                <ul class="ace-thumbnails clearfix">
                        ...
                        <li>
                                <div>
                                        <img width="150" height="150" alt="150x150" src="/Intranet/resources/fotosCertificaciones/${item.nombreimg}"  data-rel="colorbox"/>
                                        <div class="text">
                                                <div class="inner">
                                                        ...
                                                        <a href="/Intranet/emp/EgaleriaDelete.htm?id=${item.id}">
