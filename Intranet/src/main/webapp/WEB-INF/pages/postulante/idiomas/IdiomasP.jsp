...
<div>
        <a class="  btn btn-white btn-warning" href="/Intranet/pos/addIdioma.htm" data-rel="tooltip">
            Agregar Idioma
        </a>
    </div>
    <br/>
                            ...
                            <tr>
                                    ...
                                    <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/Intranet/pos/updateIdioma.htm?id=${item.id}" title="Actualizr">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>

                                                    <a class="red" href="/Intranet/pos/deleteIdioma.htm?id=${item.id}" title="Eliminar">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/pos/updateIdioma.htm?id=${item.id}" class="tooltip-success" data-rel="tooltip" title="Actualizar">
                                                                                    <span class="green">
                                                                    ...
                                                                    <li>
                                                                            <a href="/Intranet/pos/deleteIdioma.htm?id=${item.id}" class="tooltip-error" data-rel="tooltip" title="Eliminar">
                                                                                    <span class="red">
    ...
    <div class="form-group">
                                    <div class="col-sm-9"></div>
                                        ...
                                        <div class="col-sm-3 no-padding-right">
                                            <a class="btn btn-prev col-xs-12 col-sm-4 col-md-3 col-lg-6 "  href="/Intranet/pos/EstudiosP.htm">
                                                  <i class="ace-icon fa fa-arrow-left"></i> Anterior
                                            </a> 
                                            <a class="btn btn-success col-xs-12 col-sm-4 col-md-3 col-lg-6 "  href="/Intranet/pos/ConocimientosP.htm">
