                            ...
                            <form:form id="form1" action="" method="POST" commandName="idioma" class="form-horizontal" role="form">
                              ...
                              <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                ...
                                                <div class="radio">
                                                        <label>
                                                            <form:radiobutton id="nivelhablado" path="nivelhablado" value="Basico" class="ace" checked="true"/>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                ...
                                                <div class="radio">
                                                        <label>
                                                            <form:radiobutton id="nivelescrito" path="nivelescrito" value="Basico" class="ace" checked="true"/>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                                ...
                                                <div class="radio">
                                                        <label>
                                                            <form:radiobutton id="nivelleido" path="nivelleido" value="Basico" class="ace" checked="true"/>
