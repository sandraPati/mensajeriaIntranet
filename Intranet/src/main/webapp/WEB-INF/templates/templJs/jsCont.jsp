    ...
    $(document).ready(function(){
       ...
       $("#jornadaP").click(function() { 
			...
			jQuery(function($) {
				...
				$( "#duracion_contrato_desde" ).datepicker({
					showOtherMonths: true,
					selectOtherMonths: false,
					//isRTL:true,
			...
			*/
				...
				$( "#duracion_contrato_hasta" ).datepicker({
					showOtherMonths: true,
					selectOtherMonths: false,
					//isRTL:true,
