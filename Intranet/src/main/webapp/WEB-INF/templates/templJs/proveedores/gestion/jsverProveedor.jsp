...
<script src="<c:url value="/resources/assets/js/bootstrap.js" />"></script>
     ...
     $(function(){
        $("#btn_desaprobar").click(function(){ 
            $.ajax({
                   type: "POST",
                   url: "/Intranet/sup/ajaxProvDesaprobado.htm",
         ...
         $("#btn_aceptarD").click(function(){ 
            window.location.href = "/Intranet/sup/verProveedor.htm?id="+${proveedor.id};
            // Evitar ejecutar el submit del formulario.
        });
        $("#btn_aprobar").click(function(){ 
            $.ajax({
                   type: "POST",
                   url: "/Intranet/sup/ajaxProvAprobado.htm",
         ...
         $("#btn_logeoProveedor").click(function(){ 
            $.ajax({
                   type: "POST",
                   url: "/Intranet/sup/ajaxLogeoProveedor.htm",
        ...
        $("#btn_aceptarASinUsu").click(function(){ 
            $.ajax({
                   type: "POST",
                   url: "/Intranet/sup/ajaxProvAprobadoMUsu.htm",
        ...
        $("#btn_logeoProveedorUpdUsu").click(function(){ 
            $.ajax({
                   type: "POST",
                   url: "/Intranet/sup/ajaxProvAprobadoUpdUsu.htm",
