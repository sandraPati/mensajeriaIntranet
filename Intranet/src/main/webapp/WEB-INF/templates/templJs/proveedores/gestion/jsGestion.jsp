            ...
            if($('#form-field-select-3').val()!=''){
                                    var json1 =  null ; 
                                        $.ajax ({
                                            async :  false , 
                                             global :  false ,     
                                            url : '/Intranet/emp/EajaxProveedorB.json?id='+$('#form-field-select-3').val() ,
                                            dataType :  "json" , 
                                    ...
                                    "<td>"+
                                        "<img class='nav-user-photo' width='30px' height='30px'  src='/Intranet/resources/fotosPerfil/proveedores/"+dataMen[i]['nombreFoto']+"' alt='"+dataMen[i]['nombre']+"' />"+
                                         
                                    "</td>"+
                                    "<td>"+dataMen[i]['cif']+"</td>"+
                                    "<td>"+dataMen[i]['nombre']+"</td>"+
                                    "<td>"+dataMen[i]['id_actividad']['nombre']+"</td>"+
                                    
                                    "<td><a href='"+dataMen[i]['link']+"' target='_blank'  onClick='window.open(this.href, this.target, 'width=600,height=800'); return false;'>"+dataMen[i]['link']+"</a></td>"+
                                     "<td>";
                                        if( dataMen[i]['aprobado']==true){
                                          json1=json1+"Aprobado";
                                      }else{
                                        
                                           json1=json1+" NO Aprobado";
                                        }
                                    json1=json1+"</td>"+
                                    "<td>"+dataMen[i]['cantCalificacion']+"</td>"+
                                    "<td>"+
                                            
                                                "<a class='blue tooltip-info data-rel='tooltip' href='/Intranet/emp/EPverProveedor.htm?id="+dataMen[i]['id']+"' title='Detalles'>"+
                                                   "<i class='ace-icon fa fa-search-plus bigger-130'></i>"+
                                                "</a>"+
                                                "<a class='orange tooltip-warnnig' data-rel='tooltip' href='/Intranet/emp/EPupdateCalificar.htm?id="+dataMen[i]['id']+"' title='Calificacion_General'>"+
                                                   "<i class='ace-icon glyphicon  glyphicon-star-empty bigger-130'></i>"+
                                                "</a>   "+
                                                "<a class='blue tooltip-info' data-rel='tooltip' href='/Intranet/emp/EPfotoProveedor.htm?id="+dataMen[i]['id']+"' title='Cambiar Foto'>"+
                                                   "<i class='ace-icon glyphicon glyphicon-user bigger-130'></i>"+
                                                "</a> "+
                                            
                                    "</td>"+
                                    "<td>"+
                                       " <a class='blue tooltip-info' data-rel='tooltip' href='/Intranet/emp/EPverLtaPresupuestos.htm?id="+dataMen[i]['id']+"'  title='ver Presupuestos'>"+
                                        "   <i class='ace-icon fa fa-pencil-square-o bigger-130'></i>"+
                                        "</a> ";
                                           if(dataMen[i]['aprobado']==true){
                                          json1=json1+"  <a class='blue tooltip-info' data-rel='tooltip'  href='/Intranet/emp/EPverContratoProveedorPdf.htm?id="+dataMen[i]['id']+"'  title='Ver_Contrato'>"+
                                ...
                                if($('#form-field-select-3').val()!=''){
                                    ...
                                    "<td>"+
                                                ...
                                                "<a class='blue tooltip-info data-rel='tooltip' href='/Intranet/emp/EPverProveedor.htm?id="+dataMen[i]['id']+"' title='Detalles'>"+
                                                   "<i class='ace-icon fa fa-search-plus bigger-130'></i>"+
                                                "</a>"+
                                                "<a class='orange tooltip-warnnig' data-rel='tooltip' href='/Intranet/emp/EPupdateCalificar.htm?id="+dataMen[i]['id']+"' title='Calificar'>"+
                                                   "<i class='ace-icon glyphicon  glyphicon-star-empty bigger-130'></i>"+
                                                "</a>   "+
                                                "<a class='blue tooltip-info' data-rel='tooltip' href='/Intranet/emp/EPfotoProveedor.htm?id="+dataMen[i]['id']+"' title='Cambiar Foto'>"+
                                                   "<i class='ace-icon glyphicon glyphicon-user bigger-130'></i>"+
                                    ...
                                    "<td>"+
                                       " <a class='blue tooltip-info' data-rel='tooltip' href='/Intranet/emp/EPverLtaPresupuestos.htm?id="+dataMen[i]['id']+"'  title='ver Presupuestos'>"+
                                        ...
                                        "</a> ";
                                           if(dataMen[i]['aprobado']==true){
                                          json1=json1+"  <a class='blue tooltip-info' data-rel='tooltip'  href='/Intranet/emp/EPverContratoProveedorPdf.htm?id="+dataMen[i]['id']+"'  title='Ver Contrato'>"+
                                                    "<i class='ace-icon fa fa fa-search-plus bigger-130'></i>"+
                                            "</a> ";
                                            }
                                    json1=json1+"</td>"+
