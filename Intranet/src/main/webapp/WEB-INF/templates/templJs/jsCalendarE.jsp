...
<script type="text/javascript">
 ...
 $("#btn_enviar").click(function(){ 
    $.ajax({
           type: "POST",
           url: "/Intranet/sup/ajaxaddTarea.htm",
 ...
 $("#btn_enviarU").click(function(){ 
    $.ajax({
           type: "POST",
           url: "/Intranet/sup/ajaxupdateTarea.htm",
 ...
 $("#btn_delete").click(function(){ 
    $.ajax({
           type: "POST",
           url: "/Intranet/sup/ajaxdeleteTarea.htm",
           data: $("#formidU").serialize(), // Adjuntar los campos del formulario enviado.
           success: function(data)
           {
               // Mostrar la respuestas del script PHP.
...
//                    });
                    ...
                    $.getJSON('/Intranet/sup/ajaxUpdateT.json?id='+calEvent.id,{},function(data){
                        $('#myModalU #id').val(data.id);
                         $('#myModalU #nifsupervisor').val(data.nifsupervisor);
                          $('#myModalU #nifempleado').val(data.nifempleado);
                        ...
                        $('#myModalU #tipotarea_id').val(data.tipotarea_id);
                        $('#myModalU #descripcion').val(data.descripcion);
