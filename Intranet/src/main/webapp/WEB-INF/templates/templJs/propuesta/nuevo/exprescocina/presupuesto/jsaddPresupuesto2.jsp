            ...
            $('.chk').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    $.ajax({
                        ...
                        url:"/Intranet/sup/jsonAddPresupSubCap.htm",
                   ...
                   var obj={presup_id:$("#presup_id").val(),idSubCap:chk.val()};
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/sup/jsonDeletePresupSubCap.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                           //$("#tipoc").attr('disabled', 'false');
                           var ddl1 = tr.find('.SubCapCheckIcon');
            ...
            $('.chk2').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/sup/jsonguardarPanosSelecAddPresupPaso.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                           //$("#").attr('disabled', 'disabled');
                          window.location.replace("/Intranet/sup/NuevaPropuestaExpresPresupuesto2C.htm?idP=${idP}&idC=${cap.id}");
                        }
                    });
                 ...
                 if (chk.is(':checked')) {
                                ...
                                var obj={presup_id:$("#presup_id").val(),idSubCap:chk.val(),tipoCantidad:tr.find('.ddl').val()};
                                 ...
                                 $.ajax({
                                     type:'POST',
                                     contentType:'application/json',
                                     url:"/Intranet/sup/jsonAddUpdMedida.htm",
                                     data:JSON.stringify(obj),
                                     success:function(data){
                                        //$("#tipoc").attr('disabled', 'false');
                                        var ddl1 = tr.find('.SubCapCheckIcon');
