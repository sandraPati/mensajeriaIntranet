            ...
            $('.chk').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    $.ajax({
                        ...
                        url:"/Intranet/sup/jsonAddPresupVentanasM2.htm",
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/sup/jsonDeletePresupVentanasM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                            var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
            ...
            $('.chkp').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/sup/jsonAddPresupPuertasM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                          var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/sup/jsonDeletePresupPuertasM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                            var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
            ...
            $('.chka').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/sup/jsonAddPresupArmariosM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                          var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/sup/jsonDeletePresupArmariosM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                            var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
