            ...
            $('#btnsubmit').click(function () {
                if($("#tipo1").is(":checked")){
                    if($('#form-field-select-3').val()!=''){
                     window.location.replace("/Intranet/emp/ENuevaPropuestaExpresAddC.htm?cli="+$('#form-field-select-3').val());
                    }
                }
            });
            ...
            var obj={nif:$("#nif").val(),nombre:$("#nombre").val(),apellidos:$("#apellidos").val(),direccion:$("#direccion").val(),
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                          ...
                          window.location.replace("/Intranet/emp/ENuevaPropuestaExpresAddC.htm?cli="+$("#nif").val());
