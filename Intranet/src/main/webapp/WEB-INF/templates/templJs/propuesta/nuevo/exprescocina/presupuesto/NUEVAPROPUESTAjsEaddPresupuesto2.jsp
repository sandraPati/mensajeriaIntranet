...
//    alert(formData);
    ...
    if(undefined !== rows && null !== rows && rows.length>0){
     ...
     $.ajax({
           ...
           url: "/Intranet/emp/ENuevaPropuestaPresupuesto2C.htm",
            ...
            $('.chk2').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/ENuevaPropuestajsonguardarPanosSelecAddPresup.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                           //$("#").attr('disabled', 'disabled');
                           window.location.replace("/Intranet/emp/ENuevaPropuestaExpresPresupuesto2C.htm?idP=${idP}&idC=${cap.id}");
