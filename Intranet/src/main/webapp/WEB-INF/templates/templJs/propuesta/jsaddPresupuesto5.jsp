            ...
            $('.chk').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    $.ajax({
                        ...
                        url:"/Intranet/sup/jsonAddPresupEstanciaPanosM2.htm",
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/sup/jsonDeletePresupEstanciaPanosM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                            var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
                 ...
                 if (chk.is(':checked')) {
                               ...
                               var obj={idpresup_sup:${idpresup_sup},idpano:chk.val(),largo:tr.find('.ddl').val()};
                                 ...
                                 $.ajax({
                                     type:'POST',
                                     contentType:'application/json',
                                     url:"/Intranet/sup/jsonAddPresupEstanciaPanosM2Largo.htm",
                                     data:JSON.stringify(obj),
                                     success:function(data){
