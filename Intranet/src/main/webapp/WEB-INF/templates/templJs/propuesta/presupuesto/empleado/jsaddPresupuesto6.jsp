        ...
        var json1 =  null ; 
            ...
            $('.chk').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    var obj={idpresup_sup_pano:${idPresp},idvpa:chk.val()};
                   
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/EjsonAddPresupVentanasM2.htm",
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/EjsonDeletePresupVentanasM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                            var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
            ...
            $('.chkp').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    var obj={idpresup_sup_pano:${idPresp},idpuerta:chk.val()};
                   
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/EjsonAddPresupPuertasM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                          var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/EjsonDeletePresupPuertasM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                            var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
        ...
        function checkbox_changea() {
            $('.chka').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    var obj={idpresup_sup_pano:${idPresp},idarmario:chk.val()};
                   
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/EjsonAddPresupArmariosM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                          var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/EjsonDeletePresupArmariosM2.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                            var ddl1 = tr.find('.SubCapCheckIcon');
                            var ddl2 = tr.find('.SubCapCheckIcon1');
