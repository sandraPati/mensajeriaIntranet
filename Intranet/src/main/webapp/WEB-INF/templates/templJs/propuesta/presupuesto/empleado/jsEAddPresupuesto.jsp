...
<script type="text/javascript">
    ...
    function checkbox_change() {
            $('.chk').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    var obj={propuesta_id:${p.id},capitulo_id:chk.val()};
                   
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/EjsonAddPresupCap.htm",
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/EjsonDeletePresupCap.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                            var ddl1 = tr.find('.SubCapCheckIcon');
                            ddl1.hide();
  ...
  $("#table1 tbody tr").call(function (index) 
        {
            var idC=0;
