...
<script type="text/javascript">
    ...
    jQuery(function($){
                    ...
                    $('#estandar').on('change',function(e) {
                        if($("#estandar").val()=='1') {
                            
                            $("#superficiepuerta").attr("value",(0.6*2.1).toFixed(2));
                            $("#largopuerta").attr("value",0.6);
                            $("#altopuerta").attr("value",2.1);
                            $("#oculto").hide();
                       }else if($("#estandar").val()=='2') { 
                           
                           $("#superficiepuerta").attr("value",(0.7*2.1).toFixed(2));
                           $("#largopuerta").attr("value",0.7);
                            $("#altopuerta").attr("value",2.1);
                           $("#oculto").hide();
                       }else if($("#estandar").val()=='3') { 
                           
                           $("#superficiepuerta").attr("value",(0.8*2.1).toFixed(2));
                           $("#largopuerta").attr("value",0.8);
                            $("#altopuerta").attr("value",2.1);
                           $("#oculto").hide();
                       }else if($("#estandar").val()=='4') { 
                           
                           $("#superficiepuerta").attr("value",(0.9*2.1).toFixed(2));
                           $("#largopuerta").attr("value",0.9);
                            $("#altopuerta").attr("value",2.1);
                           $("#oculto").hide();
                       }else if($("#estandar").val()=='5') { 
