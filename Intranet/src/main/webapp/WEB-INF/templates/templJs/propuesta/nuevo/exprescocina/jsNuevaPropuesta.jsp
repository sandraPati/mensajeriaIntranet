            ...
            $('#btnsubmit').click(function () {
                if($("#tipo1").is(":checked")){
                    if($('#form-field-select-3').val()!=''){
                     window.location.replace("/Intranet/sup/NuevaPropuestaExpresAddC.htm?cli="+$('#form-field-select-3').val());
                    }
                }
            });
      ...
      $("#form1").submit(function(event){
            ...
            var obj={nif:$("#nif").val(),nombre:$("#nombre").val(),apellidos:$("#apellidos").val(),direccion:$("#direccion").val(),
                    ...
                    $.ajax({
                        ...
                        url:"/Intranet/sup/jsonAddClientePasoPropuesta.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                           //$("#tipoc").attr('disabled', 'false');
                          
                          window.location.replace("/Intranet/sup/NuevaPropuestaExpresAddC.htm?cli="+$("#nif").val());
