...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#cambiarfalsotecho1").click(function() {             
                $("#ft").show();
            });
             $("#cambiarfalsotecho2").click(function() {             
                $("#ft").hide();
            });
    ...
    $(function(){
        ...
        $("#btn_enviar").click(function(){
            if($('#form1').valid()==true){
                ...
                falsotechonuevo:$("#falsotechonuevo").val(),panotipo:tipopano};
          
               $.ajax({
                  type:'POST',
                  contentType:'application/json',
                  url: "/Intranet/emp/EPExpresadd.htm",
                  data:JSON.stringify(obj), // Adjuntar los campos del formulario enviado.
                  success: function(data)
                  {
                      window.location.replace("/Intranet/emp/EPExpresCocina.htm?idE="+$("#idestancia").val());
                  }
                });
            }else{ 
            ...
            $('.chk').change(function () {
                ...
                if (chk.is(':checked')) {
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/EjsonPresupuestoExpres.htm",
                   ...
                   var obj={idpano:chk.val(),idpresupexpres:$("#id").val(),idestancia:${pex.idestancia},idpropuesta:${pex.idpropuesta}};
                    ...
                    $.ajax({
                        type:'POST',
                        contentType:'application/json',
                        url:"/Intranet/emp/EjsonPresupuestoExpresDelete.htm",
                        data:JSON.stringify(obj),
                        success:function(data){
                           //$("#tipoc").attr('disabled', 'false');
                           var ddl1 = tr.find('.SubCapCheckIcon');
                 ...
                 if (chk.is(':checked')) {
                               ...
                               var obj={idpano:chk.val(),idpresupexpres:$("#id").val(),medialtura:tr.find('.ddl').val(),idestancia:${pex.idestancia},idpropuesta:${pex.idpropuesta}};
                                 ...
                                 $.ajax({
                                     type:'POST',
                                     contentType:'application/json',
                                     url:"/Intranet/emp/EjsonPresupuestoExpressMedida.htm",
                                     data:JSON.stringify(obj),
                                     success:function(data){
                                        //$("#tipoc").attr('disabled', 'false');
