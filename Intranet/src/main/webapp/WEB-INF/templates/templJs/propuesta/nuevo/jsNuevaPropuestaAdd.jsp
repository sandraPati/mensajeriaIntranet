    ...
    $(document).ready(function(){
        ...
        var json1 =  null ; 
            ...
            $("#tipo1").click(function() { 
                ...
                $("#direccion2").attr("value",$("#direccion").text());
                $("#pais2").attr("value",$("#pais").text());
                $("#provincia2").attr("value",$("#provincia").text());
                $("#poblacion2").attr("value",$("#poblacion").text());
