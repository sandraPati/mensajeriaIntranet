                ...
                if (chk.is(':checked')) {
                   var propuesta_id=chk.val();
                    ...
                    $.ajax({
                       ...
                       url: "/Intranet/emp/EDeletePlantilla.htm",
        ...
        function descuento_click() {
            $('.descuento').on("click",function () {
                ...
                //if (chk.is(':checked')) {
                   ...
                   var propuesta_id=chk.val();
                   $.getJSON('/Intranet/emp/EjsonDescuentoPropuesta.json?idP='+propuesta_id,{},function(data){
        ...
        $("#btn_enviar").click(function(){
            if($('#form1').valid()==true){
               ...
               $.ajax({
                  type:'POST',
                  contentType:'application/json',
                  url: "/Intranet/emp/ECrearPlantilla.htm",
                  data:JSON.stringify(obj), // Adjuntar los campos del formulario enviado.
                  success: function(data)
                  {
        ...
        $("#btn_enviarD").click(function(){
            if($('#formD').valid()==true){
               ...
               $.ajax({
                  type:'POST',
                  contentType:'application/json',
                  url: "/Intranet/emp/EDescuento.htm",
                  data:JSON.stringify(obj), // Adjuntar los campos del formulario enviado.
                  success: function(data)
                  {
                      //$("#respuesta").html(data); // Mostrar la respuestas del script PHP.
                    ...
                    window.location.href = "/Intranet/emp/EverPropuestas.htm?nifC=${cliente.nif}";
                       //window.location.href = data;
                  }
                });
            }else{ 
