...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var pc=$('#preciocantidad').val();
        var des=$('#descuento').val();
        var imp=$('#impuesto').val();
        var tot=$('#total').val();
        var rpc=parseFloat(pc);
        var rdes=parseFloat(des);
        var rimp=parseFloat(imp);
        var rtot=parseFloat(tot);
        $("#preciocantidad2").attr("value",(rpc).toFixed(2));
        $("#descuento2").attr("value",(rdes).toFixed(2));
        $("#impuesto2").attr("value",(rimp).toFixed(2));
        $("#total2").attr("value",(rtot).toFixed(2));
    });
