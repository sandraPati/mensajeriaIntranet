...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#causa").hide();
           ...
           //direccionMisma
           if($("#direccionMisma").is(":checked")){
                
                $("#direccionE").attr("disabled",true);
                $("#direccionE").attr("value",$('#direccionP').val());
                $('#direccionE').css('background-color', '#DCDCDC');
            }else{
                $('#direccionE').css('background-color', '#ffffff');
			...
			jQuery(function($) {
                            $('#cliente_nif').on('change',function(e) {
                                var cliente= $('#cliente_nif').val();
                                $.getJSON('/Intranet/sup/jsondireccionCliente.json?nif='+cliente,{},function(data){
                                    $('#direccionP').val(data.direccion);
                                    if($("#direccionMisma").is(":checked")){
                                        $('#direccionE').val($("#direccionP").val());
                                    }
                               });
                             });
