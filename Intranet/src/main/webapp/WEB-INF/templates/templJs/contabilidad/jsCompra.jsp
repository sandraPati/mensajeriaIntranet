   ...
   function img_click() {
            $('.descuento').on("click",function () {
                ...
                //if (chk.is(':checked')) {
                   ...
                   $.getJSON('/Intranet/sup/jsonCompraImgS.json?id='+propuesta_id,{},function(data){
                   
                        $('#myModalDescuento #avatar').attr("src","/Intranet/resources/fotosfacturas/"+data.nombreimg);
