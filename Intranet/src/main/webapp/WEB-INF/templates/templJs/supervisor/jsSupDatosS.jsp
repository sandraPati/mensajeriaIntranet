...
<script type="text/javascript">
			jQuery(function($) {
				...
				//we put a container before our table and append TableTools element to it
			    $(tableTools_obj.fnContainer()).appendTo($('.tableTools-container1'));
				...
				//and append it to our table tools btn-group, also add tooltip
				$(colvis.button())
				.prependTo('.tableTools-container1 .btn-group')
				.attr('title', 'Show/hide columns').tooltip({container: 'body'});
...
<script type="text/javascript">
			jQuery(function($) {
				...
				//initiate TableTools extension
				var tableTools_obj = new $.fn.dataTable.TableTools( oTable3, {
					"sSwfPath": "/Tienda/resources/assets/js/dataTables/extensions/TableTools/swf/copy_csv_xls_pdf.swf", //in Ace demo ../assets will be replaced by correct assets path
			        ...
			        "aButtons": [
						{
							...
							"fnComplete": function() {
								this.fnInfo( '<h3 class="no-margin-top smaller">Table copied</h3>\
									<p>Copied '+(oTable3.fnSettings().fnRecordsTotal())+' row(s) to the clipboard.</p>',
									1500
								);
							}
						},
				...
				//we put a container before our table and append TableTools element to it
			    $(tableTools_obj.fnContainer()).appendTo($('.tableTools-container3'));
				...
				//ColVis extension
				var colvis = new $.fn.dataTable.ColVis( oTable3, {
					"buttonText": "<i class='fa fa-search'></i>",
					"aiExclude": [0, 6],
					"bShowAll": true,
					//"bRestore": true,
				...
				//and append it to our table tools btn-group, also add tooltip
				$(colvis.button())
				.prependTo('.tableTools-container3 .btn-group')
				.attr('title', 'Show/hide columns').tooltip({container: 'body'});
				...
				//select/deselect all rows according to table header checkbox
				$('#dynamic-table3 > thead > tr > th input[type=checkbox]').eq(0).on('click', function(){
					var th_checked = this.checked;//checkbox inside "TH" table header
...
<script type="text/javascript">
			jQuery(function($) {
				...
				//initiate TableTools extension
				var tableTools_obj = new $.fn.dataTable.TableTools( oTable4, {
					"sSwfPath": "/Tienda/resources/assets/js/dataTables/extensions/TableTools/swf/copy_csv_xls_pdf.swf", //in Ace demo ../assets will be replaced by correct assets path
			        ...
			        "aButtons": [
						{
							...
							"fnComplete": function() {
								this.fnInfo( '<h3 class="no-margin-top smaller">Table copied</h3>\
									<p>Copied '+(oTable4.fnSettings().fnRecordsTotal())+' row(s) to the clipboard.</p>',
									1500
								);
							}
						},
				...
				//we put a container before our table and append TableTools element to it
			    $(tableTools_obj.fnContainer()).appendTo($('.tableTools-container4'));
				...
				//ColVis extension
				var colvis = new $.fn.dataTable.ColVis( oTable4, {
					"buttonText": "<i class='fa fa-search'></i>",
					"aiExclude": [0, 6],
					"bShowAll": true,
					//"bRestore": true,
				...
				//and append it to our table tools btn-group, also add tooltip
				$(colvis.button())
				.prependTo('.tableTools-container4 .btn-group')
				.attr('title', 'Show/hide columns').tooltip({container: 'body'});
				...
				//select/deselect all rows according to table header checkbox
				$('#dynamic-table4 > thead > tr > th input[type=checkbox]').eq(0).on('click', function(){
					var th_checked = this.checked;//checkbox inside "TH" table header
