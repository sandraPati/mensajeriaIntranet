...
<div id="sidebar" class="sidebar responsive sidebar-fixed">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								...
								<ul class="submenu">
									<li class="">
										<a href="/Intranet/sup/NuevaPropuesta.htm">
											<i class="menu-icon fa fa-caret-right"></i>
									...
									<li class="">
										<a href="/Intranet/sup/NuevaPropuestaExpres.htm">
											<i class="menu-icon fa fa-caret-right"></i>
										...
										<b class="arrow"></b>
                                                                        ...
                                                                        <li class="">
										<a href="/Intranet/sup/NuevaPropuestaExpresC.htm">
											<i class="menu-icon fa fa-caret-right"></i>
					...
					<li class="">
						...
						<ul class="submenu">
                                                        <li class="">
								<a href="/Intranet/sup/Resumen.htm">
									<i class="menu-icon fa fa-caret-right"></i>
									Resumen 
								</a>
							...
							<li class="">
								...
								<ul class="submenu">
									<li class="">
										<a href="/Intranet/sup/Compra.htm">
											<i class="menu-icon fa fa-caret-right"></i>
											Facturas de Compra
										</a>
						...
						<b class="arrow"></b>
                                        ...
                                        <li >
						<a href="/Intranet/sup/Mensajeria.htm">
						...
						<b class="arrow"></b>
                                        ...
                                        <li class="active">
						<a href="/Intranet/sup/CuadroMando.htm">
							<i class="menu-icon fa fa-book"></i>
