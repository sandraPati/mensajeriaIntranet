...
<script type="text/javascript">
    ...
    function crunchifyAjaxFoto() {
        $.ajax({
            url : '/Intranet/sup/ajaxtestFoto.htm',
            success : function(data) {
                $('#resultFoto').html(data);
            }
        });
    }
...
<script type="text/javascript">
    ...
    var intervalId2 = 0;
    intervalId2 = setInterval(crunchifyAjaxFoto, 5000);
    
    var intervalId3 = 0;
    intervalId3 = setInterval(crunchifyAjaxAgenda, 5000);
	...
	<div class="navbar-container" id="navbar-container">
        ...
        <li class="light-blue">
                <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        ...
                        <img id="imagenUser"class="nav-user-photo" src="/Intranet/resources/assets/avatars/user.jpg" alt="Jason's Photo" />
